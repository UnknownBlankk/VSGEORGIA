...
HX_LOCAL_STACK_FRAME(_hx_pos_67c80871309dda48_110_getWeekNumbFromSong,"LoadReplayState","getWeekNumbFromSong",0x140b87fb,"LoadReplayState.getWeekNumbFromSong","LoadReplayState.hx",110,0xb45e587a)
HX_LOCAL_STACK_FRAME(_hx_pos_67c80871309dda48_123_addSong,"LoadReplayState","addSong",0x8f3688ec,"LoadReplayState.addSong","LoadReplayState.hx",123,0xb45e587a)
HX_LOCAL_STACK_FRAME(_hx_pos_67c80871309dda48_127_addWeek,"LoadReplayState","addWeek",0x91d3c50b,"LoadReplayState.addWeek","LoadReplayState.hx",127,0xb45e587a)
static const ::String _hx_array_data_8a203cc4_21[] = {
	HX_("bf",c4,55,00,00),
};
HX_LOCAL_STACK_FRAME(_hx_pos_67c80871309dda48_143_update,"LoadReplayState","update",0x971f8073,"LoadReplayState.update","LoadReplayState.hx",143,0xb45e587a)
HX_LOCAL_STACK_FRAME(_hx_pos_67c80871309dda48_239_changeSelection,"LoadReplayState","changeSelection",0x45620112,"LoadReplayState.changeSelection","LoadReplayState.hx",239,0xb45e587a)
...
HXLINE( 236)		this->isSettingControl = false;
...
HXLINE(  47)		this->controlsStrings->sort(::Reflect_obj::compare_dyn());
...
HXLINE(  74)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("antialiasing",f4,16,b3,48),::hx::paccDynamic)) )) {
HXLINE(  76)			menuBG1->set_antialiasing(true);
            		}
HXLINE(  78)		this->add(menuBG1);
HXLINE(  80)		this->grpControls =  ::flixel::group::FlxTypedGroup_obj::__alloc( HX_CTX ,null());
HXLINE(  81)		this->add(this->grpControls);
HXLINE(  83)		{
HXLINE(  83)			int _g2 = 0;
HXDLIN(  83)			int _g3 = this->controlsStrings->length;
HXDLIN(  83)			while((_g2 < _g3)){
HXLINE(  83)				_g2 = (_g2 + 1);
HXDLIN(  83)				int i = (_g2 - 1);
HXLINE(  85)				 ::Alphabet controlLabel =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(((70 * i) + 30)) ),this->controlsStrings->__get(i),true,false,null());
HXLINE(  86)				controlLabel->isMenuItem = true;
HXLINE(  87)				controlLabel->targetY = ( (Float)(i) );
HXLINE(  88)				this->grpControls->add(controlLabel).StaticCast<  ::Alphabet >();
            			}
            		}
HXLINE(  93)		this->versionShit =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,5,(::flixel::FlxG_obj::height - 34),0,HX_("Replay Loader (ESCAPE TO GO BACK)\nNOTICE!!!! Replays are in a beta stage, and they are probably not 100% correct. expect misses and other stuff that isn't there!\n",52,06,06,66),12,null());
HXLINE(  94)		this->versionShit->scrollFactor->set(null(),null());
HXLINE(  95)		this->versionShit->setFormat(HX_("VCR OSD Mono",be,44,e4,b8),16,-1,HX_("left",07,08,b0,47),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),-16777216,null());
HXLINE(  96)		this->add(this->versionShit);
HXLINE(  99)		this->poggerDetails =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,5,34,0,HX_("Replay Details - \nnone",38,c3,7c,19),12,null());
HXLINE( 100)		this->poggerDetails->scrollFactor->set(null(),null());
HXLINE( 101)		this->poggerDetails->setFormat(HX_("VCR OSD Mono",be,44,e4,b8),16,-1,HX_("left",07,08,b0,47),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),-16777216,null());
HXLINE( 102)		this->add(this->poggerDetails);
...
int LoadReplayState_obj::getWeekNumbFromSong(::String songName){
            	HX_STACKFRAME(&_hx_pos_67c80871309dda48_110_getWeekNumbFromSong)
HXLINE( 111)		int week = 0;
HXLINE( 112)		{
HXLINE( 112)			int _g = 0;
HXDLIN( 112)			int _g1 = this->songs->length;
HXDLIN( 112)			while((_g < _g1)){
HXLINE( 112)				_g = (_g + 1);
HXDLIN( 112)				int i = (_g - 1);
HXLINE( 114)				 ::SongMetadata pog = this->songs->__get(i).StaticCast<  ::SongMetadata >();
HXLINE( 115)				if ((pog->songName == songName)) {
HXLINE( 116)					week = pog->week;
            				}
            			}
            		}
HXLINE( 118)		return week;
            	}
...
void LoadReplayState_obj::addSong(::String songName,int weekNum,::String songCharacter){
            	HX_GC_STACKFRAME(&_hx_pos_67c80871309dda48_123_addSong)
HXDLIN( 123)		::Array< ::Dynamic> _hx_tmp = this->songs;
HXDLIN( 123)		_hx_tmp->push( ::SongMetadata_obj::__alloc( HX_CTX ,songName,weekNum,songCharacter,null(),null()));
            	}
...
void LoadReplayState_obj::addWeek(::Array< ::String > songs,int weekNum,::Array< ::String > songCharacters){
            	HX_STACKFRAME(&_hx_pos_67c80871309dda48_127_addWeek)
HXLINE( 128)		if (::hx::IsNull( songCharacters )) {
HXLINE( 129)			songCharacters = ::Array_obj< ::String >::fromData( _hx_array_data_8a203cc4_21,1);
            		}
HXLINE( 131)		int num = 0;
HXLINE( 132)		{
HXLINE( 132)			int _g = 0;
HXDLIN( 132)			while((_g < songs->length)){
HXLINE( 132)				::String song = songs->__get(_g);
HXDLIN( 132)				_g = (_g + 1);
HXLINE( 134)				this->addSong(song,weekNum,songCharacters->__get(num));
HXLINE( 136)				if ((songCharacters->length != 1)) {
HXLINE( 137)					num = (num + 1);
            				}
            			}
            		}
            	}
...
void LoadReplayState_obj::update(Float elapsed){
            	HX_GC_STACKFRAME(&_hx_pos_67c80871309dda48_143_update)
HXLINE( 144)		this->super::update(elapsed);
HXLINE( 146)		if (::PlayerSettings_obj::player1->controls->_back->check()) {
HXLINE( 147)			 ::flixel::FlxState nextState =  ::OptionsMenu_obj::__alloc( HX_CTX ,null(),null());
...
HXLINE( 150)		if (::PlayerSettings_obj::player1->controls->_downP->check()) {
HXLINE( 151)			this->changeSelection(1);
            		}
HXLINE( 154)		bool _hx_tmp;
HXDLIN( 154)		if (::PlayerSettings_obj::player1->controls->_accept->check()) {
HXLINE( 154)			_hx_tmp = (Dynamic( this->grpControls->members->__get(this->curSelected)).StaticCast<  ::Alphabet >()->text != HX_("No Replays...",81,d1,ed,00));
            		}
            		else {
HXLINE( 154)			_hx_tmp = false;
            		}
HXDLIN( 154)		if (_hx_tmp) {
HXLINE( 156)			::haxe::Log_obj::trace((HX_("loading ",24,de,81,cb) + this->actualNames->__get(this->curSelected)),::hx::SourceInfo(HX_("source/LoadReplayState.hx",6e,34,7a,fb),156,HX_("LoadReplayState",c4,3c,20,8a),HX_("update",09,86,05,87)));
HXLINE( 157)			::PlayState_obj::rep = ::Replay_obj::LoadReplay(this->actualNames->__get(this->curSelected));
HXLINE( 159)			::PlayState_obj::loadRep = true;
HXLINE( 161)			if (::hx::IsEq( ::PlayState_obj::rep->replay->__Field(HX_("replayGameVer",2a,ad,0b,ce),::hx::paccDynamic),::Replay_obj::version )) {
HXLINE( 165)				::String songFormat = ::StringTools_obj::replace(( (::String)(::PlayState_obj::rep->replay->__Field(HX_("songName",c0,d0,d7,36),::hx::paccDynamic)) ),HX_(" ",20,00,00,00),HX_("-",2d,00,00,00));
HXLINE( 166)				::String _hx_switch_0 = songFormat;
            				if (  (_hx_switch_0==HX_("Dad-Battle",fe,4d,ac,32)) ){
HXLINE( 167)					songFormat = HX_("Dadbattle",9f,4a,7c,48);
HXDLIN( 167)					goto _hx_goto_22;
            				}
            				if (  (_hx_switch_0==HX_("Philly-Nice",22,f2,31,13)) ){
HXLINE( 168)					songFormat = HX_("Philly",48,eb,f2,23);
HXDLIN( 168)					goto _hx_goto_22;
            				}
            				if (  (_hx_switch_0==HX_("dad-battle",be,d5,66,07)) ){
HXLINE( 170)					songFormat = HX_("Dadbattle",9f,4a,7c,48);
HXDLIN( 170)					goto _hx_goto_22;
            				}
            				if (  (_hx_switch_0==HX_("philly-nice",22,2e,26,44)) ){
HXLINE( 171)					songFormat = HX_("Philly",48,eb,f2,23);
HXDLIN( 171)					goto _hx_goto_22;
            				}
            				_hx_goto_22:;
HXLINE( 174)				::String poop = HX_("",00,00,00,00);
HXLINE( 177)				if (( (bool)(::PlayState_obj::rep->replay->__Field(HX_("sm",9a,64,00,00),::hx::paccDynamic)) )) {
HXLINE( 178)					if (!(::sys::FileSystem_obj::exists(::StringTools_obj::replace(( (::String)(::PlayState_obj::rep->replay->__Field(HX_("chartPath",a3,75,d1,25),::hx::paccDynamic)) ),HX_("converted.json",04,d7,80,0c),HX_("",00,00,00,00))))) {
HXLINE( 180)						::lime::app::Application_obj::current->_hx___window->alert(HX_("The SM file in this replay does not exist!",59,ef,e9,5a),HX_("SM Replays",c6,39,89,69));
HXLINE( 181)						return;
            					}
            				}
HXLINE( 185)				::PlayState_obj::isSM = ( (bool)(::PlayState_obj::rep->replay->__Field(HX_("sm",9a,64,00,00),::hx::paccDynamic)) );
HXLINE( 187)				if (::PlayState_obj::isSM) {
HXLINE( 188)					::PlayState_obj::pathToSm = ::StringTools_obj::replace(( (::String)(::PlayState_obj::rep->replay->__Field(HX_("chartPath",a3,75,d1,25),::hx::paccDynamic)) ),HX_("converted.json",04,d7,80,0c),HX_("",00,00,00,00));
            				}
HXLINE( 192)				if (::PlayState_obj::isSM) {
HXLINE( 194)					poop = ::sys::io::File_obj::getContent(( (::String)(::PlayState_obj::rep->replay->__Field(HX_("chartPath",a3,75,d1,25),::hx::paccDynamic)) ));
HXLINE( 195)					try {
            						HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 197)						::String _hx_tmp = (::PlayState_obj::pathToSm + HX_("/",2f,00,00,00));
HXDLIN( 197)						::PlayState_obj::sm = ::smTools::SMFile_obj::loadFile(((_hx_tmp + ::StringTools_obj::replace(( (::String)(::PlayState_obj::rep->replay->__Field(HX_("songName",c0,d0,d7,36),::hx::paccDynamic)) ),HX_(" ",20,00,00,00),HX_("_",5f,00,00,00))) + HX_(".sm",48,4c,23,00)));
            					} catch( ::Dynamic _hx_e) {
            						if (_hx_e.IsClass<  ::Dynamic >() ){
            							HX_STACK_BEGIN_CATCH
            							 ::Dynamic _g = _hx_e;
HXLINE( 201)							 ::lime::ui::Window _hx_tmp = ::lime::app::Application_obj::current->_hx___window;
HXDLIN( 201)							::String _hx_tmp1 = ((HX_("Make sure that the SM file is called ",da,1a,ee,3a) + ::PlayState_obj::pathToSm) + HX_("/",2f,00,00,00));
HXDLIN( 201)							_hx_tmp->alert(((_hx_tmp1 + ::StringTools_obj::replace(( (::String)(::PlayState_obj::rep->replay->__Field(HX_("songName",c0,d0,d7,36),::hx::paccDynamic)) ),HX_(" ",20,00,00,00),HX_("_",5f,00,00,00))) + HX_(".sm!\nAs I couldn't read it.",2b,7b,52,56)),HX_("SM Replays",c6,39,89,69));
HXLINE( 202)							return;
            						}
            						else {
...
HXLINE( 206)					poop = ::Highscore_obj::formatSong(songFormat,( (int)(::PlayState_obj::rep->replay->__Field(HX_("songDiff",7a,ba,41,30),::hx::paccDynamic)) ));
            				}
HXLINE( 211)				try {
            					HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 213)					if (::PlayState_obj::isSM) {
HXLINE( 214)						::PlayState_obj::SONG = ::Song_obj::loadFromJsonRAW(poop);
            					}
            					else {
HXLINE( 216)						::PlayState_obj::SONG = ::Song_obj::loadFromJson(poop,( (::String)(::PlayState_obj::rep->replay->__Field(HX_("songName",c0,d0,d7,36),::hx::paccDynamic)) ));
            					}
            				} catch( ::Dynamic _hx_e) {
            					if (_hx_e.IsClass<  ::Dynamic >() ){
            						HX_STACK_BEGIN_CATCH
            						 ::Dynamic _g = _hx_e;
HXLINE( 220)						::lime::app::Application_obj::current->_hx___window->alert(HX_("Failed to load the song! Does the JSON exist?",e5,1b,ba,fe),HX_("Replays",4c,83,79,78));
HXLINE( 221)						return;
            					}
            					else {
            						HX_STACK_DO_THROW(_hx_e);
...
HXLINE( 223)				::PlayState_obj::isStoryMode = false;
HXLINE( 224)				::PlayState_obj::storyDifficulty = ( (int)(::PlayState_obj::rep->replay->__Field(HX_("songDiff",7a,ba,41,30),::hx::paccDynamic)) );
HXLINE( 225)				::PlayState_obj::storyWeek = this->getWeekNumbFromSong(( (::String)(::PlayState_obj::rep->replay->__Field(HX_("songName",c0,d0,d7,36),::hx::paccDynamic)) ));
HXLINE( 226)				{
HXLINE( 226)					 ::flixel::FlxState nextState = ::LoadingState_obj::getNextState(( ( ::flixel::FlxState)( ::PlayState_obj::__alloc( HX_CTX ,null(),null())) ),false);
...
HXLINE( 230)				::PlayState_obj::rep = null();
...
void LoadReplayState_obj::changeSelection(::hx::Null< int >  __o_change){
            	...
            	HX_STACKFRAME(&_hx_pos_67c80871309dda48_239_changeSelection)
...
HXLINE( 246)		 ::LoadReplayState _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 246)		_hx_tmp1->curSelected = (_hx_tmp1->curSelected + change);
HXLINE( 248)		if ((this->curSelected < 0)) {
HXLINE( 249)			this->curSelected = (this->grpControls->length - 1);
            		}
HXLINE( 250)		if ((this->curSelected >= this->grpControls->length)) {
HXLINE( 251)			this->curSelected = 0;
            		}
HXLINE( 253)		 ::Replay rep = ::Replay_obj::LoadReplay(this->actualNames->__get(this->curSelected));
HXLINE( 255)		 ::flixel::text::FlxText _hx_tmp2 = this->poggerDetails;
HXDLIN( 255)		::String _hx_tmp3 = ((HX_("Replay Details - \nDate Created: ",9c,0e,70,a7) + ::Std_obj::string( ::Dynamic(rep->replay->__Field(HX_("timestamp",d6,d4,ce,a5),::hx::paccDynamic)))) + HX_("\nSong: ",65,cd,f3,01));
HXDLIN( 255)		::String _hx_tmp4;
HXDLIN( 255)		if (::hx::IsNotEq( rep->replay->__Field(HX_("replayGameVer",2a,ad,0b,ce),::hx::paccDynamic),::Replay_obj::version )) {
HXLINE( 255)			_hx_tmp4 = HX_("OUTDATED not useable!",45,90,99,ff);
            		}
            		else {
HXLINE( 255)			_hx_tmp4 = HX_("Latest",67,79,f7,89);
            		}
HXDLIN( 255)		_hx_tmp2->set_text(( (::String)(((((((_hx_tmp3 + rep->replay->__Field(HX_("songName",c0,d0,d7,36),::hx::paccDynamic)) + HX_("\nReplay Version: ",8f,f9,99,d3)) + rep->replay->__Field(HX_("replayGameVer",2a,ad,0b,ce),::hx::paccDynamic)) + HX_(" (",08,1c,00,00)) + _hx_tmp4) + HX_(")\n",c1,23,00,00))) ));
HXLINE( 259)		int bullShit = 0;
HXLINE( 261)		{
HXLINE( 261)			int _g = 0;
HXDLIN( 261)			::Array< ::Dynamic> _g1 = this->grpControls->members;
HXDLIN( 261)			while((_g < _g1->length)){
HXLINE( 261)				 ::Alphabet item = _g1->__get(_g).StaticCast<  ::Alphabet >();
HXDLIN( 261)				_g = (_g + 1);
HXLINE( 263)				item->targetY = ( (Float)((bullShit - this->curSelected)) );
HXLINE( 264)				bullShit = (bullShit + 1);
HXLINE( 266)				item->set_alpha(((Float)0.6));
HXLINE( 269)				if ((item->targetY == 0)) {

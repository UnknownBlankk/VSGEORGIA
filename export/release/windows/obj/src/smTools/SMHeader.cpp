...
HX_LOCAL_STACK_FRAME(_hx_pos_41987ab568a002b9_98_readHeaderLine,"smTools.SMHeader","readHeaderLine",0x17e15591,"smTools.SMHeader.readHeaderLine","smTools/SMHeader.hx",98,0x44be2029)
namespace smTools{
...
HXLINE(  73)						::TimingStruct_obj::AllTimings->__get(currentIndex).StaticCast<  ::TimingStruct >()->startTime = (data->startTime + data->length);
            					}
HXLINE(  76)					::Array< ::Dynamic> _hx_tmp = this->changeEvents;
HXDLIN(  76)					_hx_tmp->push( ::Event_obj::__alloc( HX_CTX ,(::HelperFunctions_obj::truncateFloat(beat,0) + HX_("SM",9a,48,00,00)),beat,bpm,HX_("BPM Change",d1,e8,85,d1)));
HXLINE(  78)					if ((bpmSplit->length == 1)) {
HXLINE(  79)						goto _hx_goto_4;
            					}
HXLINE(  80)					currentIndex = (currentIndex + 1);
            				}
            				_hx_goto_4:;
            			}
HXLINE(  83)			::haxe::Log_obj::trace((this->changeEvents->length + HX_(" - BPM CHANGES",ef,a9,96,06)),::hx::SourceInfo(HX_("source/smTools/SMHeader.hx",b5,b9,02,36),83,HX_("smTools.SMHeader",b4,f8,a9,70),HX_("getBPM",e9,db,19,a3)));
HXLINE(  84)			return ((Float)0.0);
            		}
HXLINE(  86)		Float returningBPM = ::Std_obj::parseFloat(bpmSplit->__get(0).split(HX_("=",3d,00,00,00))->__get(1));
HXLINE(  87)		{
HXLINE(  87)			int _g = 0;
HXDLIN(  87)			while((_g < bpmSplit->length)){
HXLINE(  87)				::String i = bpmSplit->__get(_g);
HXDLIN(  87)				_g = (_g + 1);
HXLINE(  89)				Float bpm = ::Std_obj::parseFloat(i.split(HX_("=",3d,00,00,00))->__get(1));
HXLINE(  90)				Float beatt = ::Std_obj::parseFloat(::StringTools_obj::replace(i.split(HX_("=",3d,00,00,00))->__get(0),HX_(",",2c,00,00,00),HX_("",00,00,00,00)));
HXLINE(  91)				if ((beatt <= beat)) {
HXLINE(  92)					returningBPM = bpm;
            				}
            			}
            		}
HXLINE(  94)		return returningBPM;
            	}
...
void SMHeader_obj::readHeaderLine(::String line){
            	HX_STACKFRAME(&_hx_pos_41987ab568a002b9_98_readHeaderLine)
HXLINE(  99)		::String propName = line.split(HX_("#",23,00,00,00))->__get(1).split(HX_(":",3a,00,00,00))->__get(0);
HXLINE( 100)		::String value = line.split(HX_(":",3a,00,00,00))->__get(1).split(HX_(";",3b,00,00,00))->__get(0);
HXLINE( 101)		 ::Dynamic prop = ::Reflect_obj::getProperty(::hx::ObjectPtr<OBJ_>(this),propName);
HXLINE( 103)		if (::hx::IsNotNull( prop )) {
HXLINE( 105)			::Reflect_obj::setProperty(::hx::ObjectPtr<OBJ_>(this),propName,value);
            		}
            	}

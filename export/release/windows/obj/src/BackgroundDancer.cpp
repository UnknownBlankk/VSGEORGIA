...
HX_LOCAL_STACK_FRAME(_hx_pos_d86c65e08c62e087_26_dance,"BackgroundDancer","dance",0x01b85892,"BackgroundDancer.dance","BackgroundDancer.hx",26,0x2f720451)
...
void BackgroundDancer_obj::dance(){
            	HX_STACKFRAME(&_hx_pos_d86c65e08c62e087_26_dance)
HXLINE(  27)		this->danceDir = !(this->danceDir);
HXLINE(  29)		if (this->danceDir) {
HXLINE(  30)			this->animation->play(HX_("danceRight",a9,7f,a6,91),true,null(),null());
            		}
            		else {
HXLINE(  32)			this->animation->play(HX_("danceLeft",da,cc,f9,df),true,null(),null());
            		}
            	}

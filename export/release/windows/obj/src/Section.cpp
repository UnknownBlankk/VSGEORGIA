...
HX_DEFINE_STACK_FRAME(_hx_pos_ad46d0c3569422f9_16_new,"Section","new",0x086f9537,"Section.new","Section.hx",16,0xb56b3e19)
HX_LOCAL_STACK_FRAME(_hx_pos_ad46d0c3569422f9_29_boot,"Section","boot",0x514bfb7b,"Section.boot","Section.hx",29,0xb56b3e19)

void Section_obj::__construct(::hx::Null< int >  __o_lengthInSteps){
            		int lengthInSteps = __o_lengthInSteps.Default(16);
            	HX_STACKFRAME(&_hx_pos_ad46d0c3569422f9_16_new)
HXLINE(  24)		this->mustHitSection = true;
HXLINE(  23)		this->typeOfSection = 0;
HXLINE(  22)		this->lengthInSteps = 16;
HXLINE(  20)		this->sectionNotes = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(  19)		this->endTime = ((Float)0);
HXLINE(  18)		this->startTime = ((Float)0);
HXLINE(  33)		this->lengthInSteps = lengthInSteps;
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_ad46d0c3569422f9_29_boot)
HXDLIN(  29)		COPYCAT = 0;
            	}
}

...
HX_LOCAL_STACK_FRAME(_hx_pos_3be6f1ff2d789e96_251_update,"Note","update",0xca3a1ee5,"Note.update","Note.hx",251,0x1a8855ec)
...
HX_LOCAL_STACK_FRAME(_hx_pos_3be6f1ff2d789e96_46_boot,"Note","boot",0x09bcee0e,"Note.boot","Note.hx",46,0x1a8855ec)
...
HXLINE(  62)		this->children = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(  60)		this->sustainActive = true;
HXLINE(  59)		this->spotInLine = 0;
HXLINE(  58)		this->parent = null();
HXLINE(  57)		this->isParent = false;
HXLINE(  55)		this->arrowAngles = ::Array_obj< int >::fromData( _hx_array_data_33e34412_2,4);
HXLINE(  54)		this->quantityColor = ::Array_obj< int >::__new(8)->init(0,::Note_obj::RED_NOTE)->init(1,2)->init(2,::Note_obj::BLUE_NOTE)->init(3,2)->init(4,::Note_obj::PURP_NOTE)->init(5,2)->init(6,::Note_obj::BLUE_NOTE)->init(7,2);
HXLINE(  53)		this->dataColor = ::Array_obj< ::String >::fromData( _hx_array_data_33e34412_3,4);
HXLINE(  51)		this->localAngle = ((Float)0);
HXLINE(  50)		this->modAngle = ((Float)0);
HXLINE(  48)		this->rating = HX_("shit",c0,cf,52,4c);
HXLINE(  40)		this->noteYOff = 0;
HXLINE(  38)		this->noteScore = ((Float)1);
HXLINE(  34)		this->noteSection = 0;
HXLINE(  33)		this->originColor = 0;
HXLINE(  32)		this->isSustainNote = false;
HXLINE(  31)		this->sustainLength = ((Float)0);
HXLINE(  30)		this->modifiedByLua = false;
HXLINE(  28)		this->wasGoodHit = false;
HXLINE(  27)		this->tooLate = false;
HXLINE(  26)		this->canBeHit = false;
HXLINE(  25)		this->rawNoteData = 0;
HXLINE(  24)		this->noteData = 0;
HXLINE(  23)		this->mustPress = false;
HXLINE(  21)		this->rStrumTime = ((Float)0);
HXLINE(  19)		this->baseStrum = ((Float)0);
HXLINE(  18)		this->strumTime = ((Float)0);
HXLINE(  66)		super::__construct(null(),null(),null());
HXLINE(  68)		if (::hx::IsNull( prevNote )) {
HXLINE(  69)			prevNote = ::hx::ObjectPtr<OBJ_>(this);
            		}
HXLINE(  71)		this->prevNote = prevNote;
HXLINE(  72)		this->isSustainNote = ( (bool)(sustainNote) );
HXLINE(  74)		{
HXLINE(  74)			 ::Note _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(  74)			_g->set_x((_g->x + 50));
            		}
HXLINE(  76)		{
HXLINE(  76)			 ::Note _g1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(  76)			_g1->set_y((_g1->y - ( (Float)(2000) )));
            		}
HXLINE(  78)		if (( (bool)(inCharter) )) {
HXLINE(  80)			this->strumTime = strumTime;
HXLINE(  81)			this->rStrumTime = strumTime;
            		}
            		else {
HXLINE(  85)			this->strumTime = strumTime;
HXLINE(  86)			this->rStrumTime = (strumTime - ( (Float)((::flixel::FlxG_obj::save->data->__Field(HX_("offset",93,97,3f,60),::hx::paccDynamic) + ::PlayState_obj::songOffset)) ));
HXLINE(  88)			if (::PlayState_obj::isSM) {
HXLINE(  90)				Float _hx_tmp = this->rStrumTime;
HXDLIN(  90)				this->rStrumTime = ( (Float)(::Math_obj::round((_hx_tmp + ::Std_obj::parseFloat(::PlayState_obj::sm->header->OFFSET)))) );
            			}
            		}
HXLINE(  96)		if ((this->strumTime < 0)) {
HXLINE(  97)			this->strumTime = ( (Float)(0) );
            		}
HXLINE(  99)		this->noteData = noteData;
HXLINE( 101)		::String daStage = ::PlayState_obj::curStage;
HXLINE( 104)		::String noteTypeCheck = HX_("normal",27,72,69,30);
HXLINE( 106)		if (( (bool)(inCharter) )) {
HXLINE( 108)			::String library = null();
HXDLIN( 108)			bool usecahce = ( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("cacheImages",9a,7c,33,1d),::hx::paccDynamic)) );
HXDLIN( 108)			::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("NOTE_assets",70,3c,09,f7)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 108)			this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("NOTE_assets",70,3c,09,f7)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library)));
HXLINE( 110)			{
HXLINE( 111)				{
HXLINE( 112)					this->animation->addByPrefix((this->dataColor->__get(0) + HX_("Scroll",2d,4c,f9,7b)),(this->dataColor->__get(0) + HX_(" alone",3b,76,01,ed)),null(),null(),null(),null());
HXLINE( 113)					this->animation->addByPrefix((this->dataColor->__get(0) + HX_("hold",3f,c9,12,45)),(this->dataColor->__get(0) + HX_(" hold",5f,59,e5,b1)),null(),null(),null(),null());
HXLINE( 114)					this->animation->addByPrefix((this->dataColor->__get(0) + HX_("holdend",fc,4b,02,b8)),(this->dataColor->__get(0) + HX_(" tail",b0,46,c9,b9)),null(),null(),null(),null());
            				}
HXLINE( 111)				{
HXLINE( 112)					this->animation->addByPrefix((this->dataColor->__get(1) + HX_("Scroll",2d,4c,f9,7b)),(this->dataColor->__get(1) + HX_(" alone",3b,76,01,ed)),null(),null(),null(),null());
HXLINE( 113)					this->animation->addByPrefix((this->dataColor->__get(1) + HX_("hold",3f,c9,12,45)),(this->dataColor->__get(1) + HX_(" hold",5f,59,e5,b1)),null(),null(),null(),null());
HXLINE( 114)					this->animation->addByPrefix((this->dataColor->__get(1) + HX_("holdend",fc,4b,02,b8)),(this->dataColor->__get(1) + HX_(" tail",b0,46,c9,b9)),null(),null(),null(),null());
            				}
HXLINE( 111)				{
HXLINE( 112)					this->animation->addByPrefix((this->dataColor->__get(2) + HX_("Scroll",2d,4c,f9,7b)),(this->dataColor->__get(2) + HX_(" alone",3b,76,01,ed)),null(),null(),null(),null());
HXLINE( 113)					this->animation->addByPrefix((this->dataColor->__get(2) + HX_("hold",3f,c9,12,45)),(this->dataColor->__get(2) + HX_(" hold",5f,59,e5,b1)),null(),null(),null(),null());
HXLINE( 114)					this->animation->addByPrefix((this->dataColor->__get(2) + HX_("holdend",fc,4b,02,b8)),(this->dataColor->__get(2) + HX_(" tail",b0,46,c9,b9)),null(),null(),null(),null());
            				}
HXLINE( 111)				{
HXLINE( 112)					this->animation->addByPrefix((this->dataColor->__get(3) + HX_("Scroll",2d,4c,f9,7b)),(this->dataColor->__get(3) + HX_(" alone",3b,76,01,ed)),null(),null(),null(),null());
HXLINE( 113)					this->animation->addByPrefix((this->dataColor->__get(3) + HX_("hold",3f,c9,12,45)),(this->dataColor->__get(3) + HX_(" hold",5f,59,e5,b1)),null(),null(),null(),null());
HXLINE( 114)					this->animation->addByPrefix((this->dataColor->__get(3) + HX_("holdend",fc,4b,02,b8)),(this->dataColor->__get(3) + HX_(" tail",b0,46,c9,b9)),null(),null(),null(),null());
            				}
            			}
HXLINE( 117)			this->setGraphicSize(::Std_obj::_hx_int((this->get_width() * ((Float)0.7))),null());
HXLINE( 118)			this->updateHitbox();
HXLINE( 119)			if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("antialiasing",f4,16,b3,48),::hx::paccDynamic)) )) {
HXLINE( 121)				this->set_antialiasing(true);
            			}
            		}
            		else {
HXLINE( 126)			if (::hx::IsNull( ::PlayState_obj::SONG->__Field(HX_("noteStyle",df,ef,aa,c1),::hx::paccDynamic) )) {
HXLINE( 127)				if ((::PlayState_obj::storyWeek == 6)) {
HXLINE( 127)					noteTypeCheck = HX_("pixel",86,c6,a3,c2);
            				}
            			}
            			else {
HXLINE( 128)				noteTypeCheck = ( (::String)(::PlayState_obj::SONG->__Field(HX_("noteStyle",df,ef,aa,c1),::hx::paccDynamic)) );
            			}
HXLINE( 130)			::String _hx_switch_0 = noteTypeCheck;
...
HXDLIN( 147)				::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("NOTE_assets_NoE",35,0a,3f,76)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 147)				this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("NOTE_assets_NoE",35,0a,3f,76)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library)));
HXLINE( 149)				{
HXLINE( 150)					{
...
HXLINE( 161)					this->set_antialiasing(true);
            				}
HXLINE( 146)				goto _hx_goto_0;
            			}
            			if (  (_hx_switch_0==HX_("pixel",86,c6,a3,c2)) ){
HXLINE( 133)				this->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/pixelUI/arrows-pixels",b7,c3,c7,09)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("week6",c2,95,be,c7)),true,17,17,null(),null());
HXLINE( 134)				if (this->isSustainNote) {
HXLINE( 135)					this->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/pixelUI/arrowEnds",08,21,6c,fd)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("week6",c2,95,be,c7)),true,7,6,null(),null());
            				}
HXLINE( 137)				{
HXLINE( 138)					{
HXLINE( 139)						this->animation->add((this->dataColor->__get(0) + HX_("Scroll",2d,4c,f9,7b)),::Array_obj< int >::fromData( _hx_array_data_33e34412_4,1),null(),null(),null(),null());
HXLINE( 140)						this->animation->add((this->dataColor->__get(0) + HX_("hold",3f,c9,12,45)),::Array_obj< int >::fromData( _hx_array_data_33e34412_5,1),null(),null(),null(),null());
HXLINE( 141)						this->animation->add((this->dataColor->__get(0) + HX_("holdend",fc,4b,02,b8)),::Array_obj< int >::fromData( _hx_array_data_33e34412_6,1),null(),null(),null(),null());
            					}
HXLINE( 138)					{
HXLINE( 139)						this->animation->add((this->dataColor->__get(1) + HX_("Scroll",2d,4c,f9,7b)),::Array_obj< int >::fromData( _hx_array_data_33e34412_7,1),null(),null(),null(),null());
HXLINE( 140)						this->animation->add((this->dataColor->__get(1) + HX_("hold",3f,c9,12,45)),::Array_obj< int >::fromData( _hx_array_data_33e34412_8,1),null(),null(),null(),null());
HXLINE( 141)						this->animation->add((this->dataColor->__get(1) + HX_("holdend",fc,4b,02,b8)),::Array_obj< int >::fromData( _hx_array_data_33e34412_9,1),null(),null(),null(),null());
            					}
HXLINE( 138)					{
HXLINE( 139)						this->animation->add((this->dataColor->__get(2) + HX_("Scroll",2d,4c,f9,7b)),::Array_obj< int >::fromData( _hx_array_data_33e34412_10,1),null(),null(),null(),null());
HXLINE( 140)						this->animation->add((this->dataColor->__get(2) + HX_("hold",3f,c9,12,45)),::Array_obj< int >::fromData( _hx_array_data_33e34412_11,1),null(),null(),null(),null());
HXLINE( 141)						this->animation->add((this->dataColor->__get(2) + HX_("holdend",fc,4b,02,b8)),::Array_obj< int >::fromData( _hx_array_data_33e34412_12,1),null(),null(),null(),null());
            					}
HXLINE( 138)					{
HXLINE( 139)						this->animation->add((this->dataColor->__get(3) + HX_("Scroll",2d,4c,f9,7b)),::Array_obj< int >::fromData( _hx_array_data_33e34412_13,1),null(),null(),null(),null());
HXLINE( 140)						this->animation->add((this->dataColor->__get(3) + HX_("hold",3f,c9,12,45)),::Array_obj< int >::fromData( _hx_array_data_33e34412_14,1),null(),null(),null(),null());
HXLINE( 141)						this->animation->add((this->dataColor->__get(3) + HX_("holdend",fc,4b,02,b8)),::Array_obj< int >::fromData( _hx_array_data_33e34412_15,1),null(),null(),null(),null());
            					}
            				}
HXLINE( 144)				Float _hx_tmp = this->get_width();
HXDLIN( 144)				this->setGraphicSize(::Std_obj::_hx_int((_hx_tmp * ::PlayState_obj::daPixelZoom)),null());
...
HXDLIN( 164)				::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("NOTE_assets",70,3c,09,f7)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 164)				this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("NOTE_assets",70,3c,09,f7)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library)));
HXLINE( 166)				{
HXLINE( 167)					{
HXLINE( 168)						this->animation->addByPrefix((this->dataColor->__get(0) + HX_("Scroll",2d,4c,f9,7b)),(this->dataColor->__get(0) + HX_(" alone",3b,76,01,ed)),null(),null(),null(),null());
HXLINE( 169)						this->animation->addByPrefix((this->dataColor->__get(0) + HX_("hold",3f,c9,12,45)),(this->dataColor->__get(0) + HX_(" hold",5f,59,e5,b1)),null(),null(),null(),null());
HXLINE( 170)						this->animation->addByPrefix((this->dataColor->__get(0) + HX_("holdend",fc,4b,02,b8)),(this->dataColor->__get(0) + HX_(" tail",b0,46,c9,b9)),null(),null(),null(),null());
            					}
HXLINE( 167)					{
HXLINE( 168)						this->animation->addByPrefix((this->dataColor->__get(1) + HX_("Scroll",2d,4c,f9,7b)),(this->dataColor->__get(1) + HX_(" alone",3b,76,01,ed)),null(),null(),null(),null());
HXLINE( 169)						this->animation->addByPrefix((this->dataColor->__get(1) + HX_("hold",3f,c9,12,45)),(this->dataColor->__get(1) + HX_(" hold",5f,59,e5,b1)),null(),null(),null(),null());
HXLINE( 170)						this->animation->addByPrefix((this->dataColor->__get(1) + HX_("holdend",fc,4b,02,b8)),(this->dataColor->__get(1) + HX_(" tail",b0,46,c9,b9)),null(),null(),null(),null());
            					}
HXLINE( 167)					{
HXLINE( 168)						this->animation->addByPrefix((this->dataColor->__get(2) + HX_("Scroll",2d,4c,f9,7b)),(this->dataColor->__get(2) + HX_(" alone",3b,76,01,ed)),null(),null(),null(),null());
HXLINE( 169)						this->animation->addByPrefix((this->dataColor->__get(2) + HX_("hold",3f,c9,12,45)),(this->dataColor->__get(2) + HX_(" hold",5f,59,e5,b1)),null(),null(),null(),null());
HXLINE( 170)						this->animation->addByPrefix((this->dataColor->__get(2) + HX_("holdend",fc,4b,02,b8)),(this->dataColor->__get(2) + HX_(" tail",b0,46,c9,b9)),null(),null(),null(),null());
            					}
HXLINE( 167)					{
HXLINE( 168)						this->animation->addByPrefix((this->dataColor->__get(3) + HX_("Scroll",2d,4c,f9,7b)),(this->dataColor->__get(3) + HX_(" alone",3b,76,01,ed)),null(),null(),null(),null());
HXLINE( 169)						this->animation->addByPrefix((this->dataColor->__get(3) + HX_("hold",3f,c9,12,45)),(this->dataColor->__get(3) + HX_(" hold",5f,59,e5,b1)),null(),null(),null(),null());
HXLINE( 170)						this->animation->addByPrefix((this->dataColor->__get(3) + HX_("holdend",fc,4b,02,b8)),(this->dataColor->__get(3) + HX_(" tail",b0,46,c9,b9)),null(),null(),null(),null());
            					}
            				}
HXLINE( 173)				this->setGraphicSize(::Std_obj::_hx_int((this->get_width() * ((Float)0.7))),null());
HXLINE( 174)				this->updateHitbox();
HXLINE( 176)				if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("antialiasing",f4,16,b3,48),::hx::paccDynamic)) )) {
HXLINE( 178)					this->set_antialiasing(true);
            				}
            			}
            			_hx_goto_0:;
            		}
...
HXDLIN( 183)			_g2->set_x((_g2->x + (::Note_obj::swagWidth * ( (Float)(noteData) ))));
            		}
HXLINE( 184)		this->animation->play((this->dataColor->__get(noteData) + HX_("Scroll",2d,4c,f9,7b)),null(),null(),null());
HXLINE( 185)		this->originColor = noteData;
HXLINE( 187)		bool _hx_tmp;
HXDLIN( 187)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("stepMania",06,56,8a,73),::hx::paccDynamic)) )) {
HXLINE( 187)			_hx_tmp = !(this->isSustainNote);
            		}
            		else {
HXLINE( 187)			_hx_tmp = false;
            		}
HXDLIN( 187)		if (_hx_tmp) {
HXLINE( 189)			Float strumCheck = this->rStrumTime;
HXLINE( 195)			int ind = ::Std_obj::_hx_int(( (Float)(::Math_obj::round((strumCheck / (::Conductor_obj::stepCrochet / ( (Float)(2) ))))) ));
HXLINE( 197)			int col = 0;
HXLINE( 198)			col = this->quantityColor->__get(::hx::Mod(ind,8));
HXLINE( 200)			this->animation->play((this->dataColor->__get(col) + HX_("Scroll",2d,4c,f9,7b)),null(),null(),null());
HXLINE( 201)			 ::Note _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 201)			_hx_tmp->localAngle = (_hx_tmp->localAngle - ( (Float)(this->arrowAngles->__get(col)) ));
HXLINE( 202)			 ::Note _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 202)			_hx_tmp1->localAngle = (_hx_tmp1->localAngle + this->arrowAngles->__get(noteData));
HXLINE( 203)			this->originColor = col;
            		}
HXLINE( 210)		bool _hx_tmp1;
HXDLIN( 210)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("downscroll",ef,45,d4,4f),::hx::paccDynamic)) )) {
HXLINE( 210)			_hx_tmp1 = ( (bool)(sustainNote) );
            		}
            		else {
HXLINE( 210)			_hx_tmp1 = false;
            		}
HXDLIN( 210)		if (_hx_tmp1) {
HXLINE( 211)			this->set_flipY(true);
            		}
HXLINE( 213)		Float stepHeight = (((Float)0.45) * ::Conductor_obj::stepCrochet);
HXDLIN( 213)		Float stepHeight1;
HXDLIN( 213)		if ((::PlayStateChangeables_obj::scrollSpeed == 1)) {
HXLINE( 213)			stepHeight1 = ( (Float)(::PlayState_obj::SONG->__Field(HX_("speed",87,97,69,81),::hx::paccDynamic)) );
            		}
            		else {
HXLINE( 213)			stepHeight1 = ::PlayStateChangeables_obj::scrollSpeed;
            		}
HXDLIN( 213)		Float stepHeight2 = (stepHeight * ::flixel::math::FlxMath_obj::roundDecimal(stepHeight1,2));
HXLINE( 215)		bool _hx_tmp2;
HXDLIN( 215)		if (this->isSustainNote) {
HXLINE( 215)			_hx_tmp2 = ::hx::IsNotNull( prevNote );
            		}
            		else {
HXLINE( 215)			_hx_tmp2 = false;
            		}
HXDLIN( 215)		if (_hx_tmp2) {
HXLINE( 218)			this->set_alpha(((Float)0.6));
HXLINE( 220)			{
HXLINE( 220)				 ::Note _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 220)				Float _g1 = _g->x;
HXDLIN( 220)				_g->set_x((_g1 + (this->get_width() / ( (Float)(2) ))));
            			}
HXLINE( 222)			this->originColor = prevNote->originColor;
HXLINE( 224)			this->animation->play((this->dataColor->__get(this->originColor) + HX_("holdend",fc,4b,02,b8)),null(),null(),null());
HXLINE( 225)			this->updateHitbox();
HXLINE( 227)			{
HXLINE( 227)				 ::Note _g2 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 227)				Float _g3 = _g2->x;
HXDLIN( 227)				_g2->set_x((_g3 - (this->get_width() / ( (Float)(2) ))));
            			}
HXLINE( 231)			if (( (bool)(inCharter) )) {
HXLINE( 232)				 ::Note _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 232)				_g->set_x((_g->x + 30));
            			}
HXLINE( 234)			if (prevNote->isSustainNote) {
HXLINE( 236)				prevNote->animation->play((this->dataColor->__get(prevNote->originColor) + HX_("hold",3f,c9,12,45)),null(),null(),null());
HXLINE( 237)				prevNote->updateHitbox();
HXLINE( 239)				{
HXLINE( 239)					 ::flixel::math::FlxPoint _g = prevNote->scale;
HXDLIN( 239)					Float _g1 = _g->y;
HXDLIN( 239)					_g->set_y((_g1 * ((stepHeight2 + 1) / prevNote->get_height())));
            				}
HXLINE( 240)				prevNote->updateHitbox();
HXLINE( 241)				prevNote->noteYOff = ::Math_obj::round(-(prevNote->offset->y));
HXLINE( 245)				this->noteYOff = ::Math_obj::round(-(this->offset->y));
            			}
            		}
            	}
...
void Note_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_3be6f1ff2d789e96_251_update)
HXLINE( 252)		this->super::update(elapsed);
HXLINE( 253)		this->set_angle((this->modAngle + this->localAngle));
HXLINE( 255)		if (!(this->modifiedByLua)) {
HXLINE( 257)			if (!(this->sustainActive)) {
HXLINE( 259)				this->set_alpha(((Float)0.3));
            			}
            		}
HXLINE( 263)		if (this->mustPress) {
HXLINE( 266)			if (this->isSustainNote) {
HXLINE( 268)				bool _hx_tmp;
HXDLIN( 268)				if ((this->strumTime > (::Conductor_obj::songPosition - (::Conductor_obj::safeZoneOffset * ((Float)1.5))))) {
HXLINE( 268)					_hx_tmp = (this->strumTime < (::Conductor_obj::songPosition + (::Conductor_obj::safeZoneOffset * ((Float)0.5))));
            				}
            				else {
HXLINE( 268)					_hx_tmp = false;
            				}
HXDLIN( 268)				if (_hx_tmp) {
HXLINE( 270)					this->canBeHit = true;
            				}
            				else {
HXLINE( 272)					this->canBeHit = false;
            				}
            			}
            			else {
HXLINE( 276)				bool _hx_tmp;
HXDLIN( 276)				if ((this->strumTime > (::Conductor_obj::songPosition - ::Conductor_obj::safeZoneOffset))) {
HXLINE( 276)					_hx_tmp = (this->strumTime < (::Conductor_obj::songPosition + ::Conductor_obj::safeZoneOffset));
            				}
            				else {
HXLINE( 276)					_hx_tmp = false;
            				}
HXDLIN( 276)				if (_hx_tmp) {
HXLINE( 278)					this->canBeHit = true;
            				}
            				else {
HXLINE( 280)					this->canBeHit = false;
            				}
            			}
HXLINE( 283)			bool _hx_tmp;
HXDLIN( 283)			if ((this->strumTime < (::Conductor_obj::songPosition - (::Conductor_obj::safeZoneOffset * ::Conductor_obj::timeScale)))) {
HXLINE( 283)				_hx_tmp = !(this->wasGoodHit);
            			}
            			else {
HXLINE( 283)				_hx_tmp = false;
            			}
HXDLIN( 283)			if (_hx_tmp) {
HXLINE( 284)				this->tooLate = true;
            			}
            		}
            		else {
HXLINE( 288)			this->canBeHit = false;
HXLINE( 290)			if ((this->strumTime <= ::Conductor_obj::songPosition)) {
HXLINE( 291)				this->wasGoodHit = true;
            			}
            		}
HXLINE( 294)		if (this->tooLate) {
HXLINE( 296)			if ((this->alpha > ((Float)0.3))) {
HXLINE( 297)				this->set_alpha(((Float)0.3));
            			}
            		}
            	}
...
HXDLIN(  42)		swagWidth = ((Float)112.);
            	}
{
            	HX_STACKFRAME(&_hx_pos_3be6f1ff2d789e96_43_boot)
HXDLIN(  43)		PURP_NOTE = 0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_3be6f1ff2d789e96_44_boot)
HXDLIN(  44)		GREEN_NOTE = 2;
            	}
{
            	HX_STACKFRAME(&_hx_pos_3be6f1ff2d789e96_45_boot)
HXDLIN(  45)		BLUE_NOTE = 1;
            	}
{
            	HX_STACKFRAME(&_hx_pos_3be6f1ff2d789e96_46_boot)
HXDLIN(  46)		RED_NOTE = 3;
            	}
}

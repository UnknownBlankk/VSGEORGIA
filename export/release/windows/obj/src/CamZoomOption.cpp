...
HX_DEFINE_STACK_FRAME(_hx_pos_7858b555654f959a_768_new,"CamZoomOption","new",0xae7b5429,"CamZoomOption.new","Options.hx",768,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_7858b555654f959a_773_press,"CamZoomOption","press",0xf26f1b8c,"CamZoomOption.press","Options.hx",773,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_7858b555654f959a_781_updateDisplay,"CamZoomOption","updateDisplay",0x0b240842,"CamZoomOption.updateDisplay","Options.hx",781,0x9d9a0240)

void CamZoomOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_7858b555654f959a_768_new)
HXLINE( 769)		super::__construct();
...
bool CamZoomOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_7858b555654f959a_773_press)
HXLINE( 774)		::flixel::FlxG_obj::save->data->__SetField(HX_("camzoom",a2,ca,10,f1),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("camzoom",a2,ca,10,f1),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 775)		this->display = this->updateDisplay();
HXLINE( 776)		return true;
            	}


::String CamZoomOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_7858b555654f959a_781_updateDisplay)
HXDLIN( 781)		::String _hx_tmp;
HXDLIN( 781)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("camzoom",a2,ca,10,f1),::hx::paccDynamic)) ))) {
HXDLIN( 781)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
            		else {
HXDLIN( 781)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
HXDLIN( 781)		return (HX_("Camera Zoom ",f2,a5,9b,43) + _hx_tmp);
            	}

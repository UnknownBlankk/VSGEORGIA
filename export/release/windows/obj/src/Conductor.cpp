...
HX_LOCAL_STACK_FRAME(_hx_pos_9bd24c9adde08dff_73_recalculateTimingStruct,"Conductor","recalculateTimingStruct",0xaba6fecb,"Conductor.recalculateTimingStruct","Conductor.hx",73,0xeb0fa157)
HX_LOCAL_STACK_FRAME(_hx_pos_9bd24c9adde08dff_88_changeBPM,"Conductor","changeBPM",0xeafb6fe8,"Conductor.changeBPM","Conductor.hx",88,0xeb0fa157)
...
void Conductor_obj::recalculateTimingStruct( ::Song SONG){
            	HX_STACKFRAME(&_hx_pos_9bd24c9adde08dff_73_recalculateTimingStruct)
HXDLIN(  73)		int _g = 0;
HXDLIN(  73)		::Array< ::Dynamic> _g1 = SONG->eventObjects;
HXDLIN(  73)		while((_g < _g1->length)){
HXDLIN(  73)			 ::Event i = _g1->__get(_g).StaticCast<  ::Event >();
HXDLIN(  73)			_g = (_g + 1);
            		}
            	}
...
void Conductor_obj::changeBPM(Float newBpm, ::Dynamic __o_recalcLength){
            	...
            	HX_STACKFRAME(&_hx_pos_9bd24c9adde08dff_88_changeBPM)
HXLINE(  89)		::Conductor_obj::bpm = newBpm;
HXLINE(  91)		::Conductor_obj::crochet = ((( (Float)(60) ) / ::Conductor_obj::bpm) * ( (Float)(1000) ));
HXLINE(  92)		::Conductor_obj::stepCrochet = (::Conductor_obj::crochet / ( (Float)(4) ));
            	}

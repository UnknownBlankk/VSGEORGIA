...
HX_LOCAL_STACK_FRAME(_hx_pos_17d383cbce329512_265_destroy,"PauseSubState","destroy",0xc2ba82f3,"PauseSubState.destroy","PauseSubState.hx",265,0x953dc7b7)
HX_LOCAL_STACK_FRAME(_hx_pos_17d383cbce329512_272_changeSelection,"PauseSubState","changeSelection",0x8f960fb5,"PauseSubState.changeSelection","PauseSubState.hx",272,0x953dc7b7)
...
HXLINE( 194)									 ::Alphabet songText =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(((70 * i) + 30)) ),this->menuItems->__get(i),true,false,null());
...
HXLINE( 212)			::String _hx_switch_1 = daSelected;
            			if (  (_hx_switch_1==HX_("Exit to menu",82,87,9a,a9)) ){
HXLINE( 226)				::PlayState_obj::startTime = ( (Float)(0) );
HXLINE( 227)				if (::PlayState_obj::instance->useVideo) {
HXLINE( 229)					::GlobalVideo_obj::get()->__Field(HX_("stop",02,f0,5b,4c),::hx::paccDynamic)();
HXLINE( 230)					::PlayState_obj::instance->remove(::PlayState_obj::instance->videoSprite,null()).StaticCast<  ::flixel::FlxBasic >();
HXLINE( 231)					::PlayState_obj::instance->removedVideo = true;
            				}
HXLINE( 233)				if (::PlayState_obj::loadRep) {
HXLINE( 235)					::flixel::FlxG_obj::save->data->__SetField(HX_("botplay",7b,fb,a9,61),false,::hx::paccDynamic);
HXLINE( 236)					::flixel::FlxG_obj::save->data->__SetField(HX_("scrollSpeed",3a,e0,46,cb),1,::hx::paccDynamic);
HXLINE( 237)					::flixel::FlxG_obj::save->data->__SetField(HX_("downscroll",ef,45,d4,4f),false,::hx::paccDynamic);
            				}
HXLINE( 239)				::PlayState_obj::loadRep = false;
HXLINE( 241)				if (::hx::IsNotNull( ::PlayState_obj::luaModchart )) {
HXLINE( 243)					::PlayState_obj::luaModchart->die();
HXLINE( 244)					::PlayState_obj::luaModchart = null();
            				}
HXLINE( 247)				if (::hx::IsGreater( ::flixel::FlxG_obj::save->data->__Field(HX_("fpsCap",a9,7b,7e,91),::hx::paccDynamic),290 )) {
HXLINE( 248)					::hx::TCast<  ::Main >::cast(::openfl::Lib_obj::get_current()->getChildAt(0))->setFPSCap(( (Float)(290) ));
            				}
HXLINE( 250)				if (::PlayState_obj::isStoryMode) {
HXLINE( 251)					 ::flixel::FlxState nextState =  ::StoryMenuState_obj::__alloc( HX_CTX ,null(),null());
HXDLIN( 251)					if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE( 251)						::flixel::FlxG_obj::game->_requestedState = nextState;
            					}
            				}
            				else {
HXLINE( 253)					 ::flixel::FlxState nextState =  ::FreeplayState_obj::__alloc( HX_CTX ,null(),null());
...
HXLINE( 217)				::PlayState_obj::startTime = ( (Float)(0) );
HXLINE( 218)				if (::PlayState_obj::instance->useVideo) {
HXLINE( 220)					::GlobalVideo_obj::get()->__Field(HX_("stop",02,f0,5b,4c),::hx::paccDynamic)();
HXLINE( 221)					::PlayState_obj::instance->remove(::PlayState_obj::instance->videoSprite,null()).StaticCast<  ::flixel::FlxBasic >();
HXLINE( 222)					::PlayState_obj::instance->removedVideo = true;
            				}
HXLINE( 224)				{
HXLINE( 224)					 ::flixel::FlxState nextState = ( ( ::flixel::FlxState)(::Type_obj::createInstance(::Type_obj::getClass(::flixel::FlxG_obj::game->_state),::cpp::VirtualArray_obj::__new(0))) );
HXDLIN( 224)					if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE( 224)						::flixel::FlxG_obj::game->_requestedState = nextState;
            					}
            				}
HXLINE( 216)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_1==HX_("Resume",cd,dd,18,3d)) ){
HXLINE( 215)				this->close();
...
HXDLIN( 257)		bool _hx_tmp3 = _this->keyManager->checkStatus(74,_this->status);
            	}


void PauseSubState_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_17d383cbce329512_265_destroy)
HXLINE( 266)		this->pauseMusic->destroy();
...
void PauseSubState_obj::changeSelection(::hx::Null< int >  __o_change){
            	...
            	HX_STACKFRAME(&_hx_pos_17d383cbce329512_272_changeSelection)
HXLINE( 273)		 ::PauseSubState _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 273)		_hx_tmp->curSelected = (_hx_tmp->curSelected + change);
HXLINE( 275)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp1 = ::flixel::FlxG_obj::sound;
HXDLIN( 275)		_hx_tmp1->play(::Paths_obj::sound(HX_("scrollMenu",4c,d4,18,06),null()),((Float)0.4),null(),null(),null(),null());

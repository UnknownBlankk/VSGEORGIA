...
HX_DEFINE_STACK_FRAME(_hx_pos_6e3535bb8cfd14a6_261_new,"MultiCallback","new",0x3682e930,"MultiCallback.new","LoadingState.hx",261,0x53ff9bc9)
HX_LOCAL_STACK_FRAME(_hx_pos_6e3535bb8cfd14a6_285_add,"MultiCallback","add",0x36790af1,"MultiCallback.add","LoadingState.hx",285,0x53ff9bc9)
HX_LOCAL_STACK_FRAME(_hx_pos_6e3535bb8cfd14a6_278_add,"MultiCallback","add",0x36790af1,"MultiCallback.add","LoadingState.hx",278,0x53ff9bc9)
HX_LOCAL_STACK_FRAME(_hx_pos_6e3535bb8cfd14a6_310_log,"MultiCallback","log",0x36816d54,"MultiCallback.log","LoadingState.hx",310,0x53ff9bc9)
HX_LOCAL_STACK_FRAME(_hx_pos_6e3535bb8cfd14a6_314_getFired,"MultiCallback","getFired",0x1ac970a8,"MultiCallback.getFired","LoadingState.hx",314,0x53ff9bc9)
...
void MultiCallback_obj::__construct( ::Dynamic callback,::String logId){
            	HX_GC_STACKFRAME(&_hx_pos_6e3535bb8cfd14a6_261_new)
HXLINE( 269)		this->fired = ::Array_obj< ::String >::__new();
HXLINE( 268)		this->unfired =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXLINE( 266)		this->numRemaining = 0;
HXLINE( 265)		this->length = 0;
HXLINE( 264)		this->logId = null();
HXLINE( 273)		this->callback = callback;
HXLINE( 274)		this->logId = logId;
            	}
...
bool MultiCallback_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic MultiCallback_obj::add(::String __o_id){
            		...
            		void _hx_run(){
            			HX_STACKFRAME(&_hx_pos_6e3535bb8cfd14a6_285_add)
HXLINE( 285)			if (_gthis->unfired->exists(id)) {
HXLINE( 287)				_gthis->unfired->remove(id);
HXLINE( 288)				_gthis->fired->push(id);
HXLINE( 289)				_gthis->numRemaining--;
HXLINE( 291)				if (::hx::IsNotNull( _gthis->logId )) {
HXLINE( 292)					if (::hx::IsNotNull( _gthis->logId )) {
HXLINE( 292)						::haxe::Log_obj::trace((((HX_("",00,00,00,00) + _gthis->logId) + HX_(": ",a6,32,00,00)) + ((((HX_("fired ",72,04,21,89) + id) + HX_(", ",74,26,00,00)) + _gthis->numRemaining) + HX_(" remaining",d6,c2,10,c5))),::hx::SourceInfo(HX_("source/LoadingState.hx",55,7f,fd,f0),311,HX_("MultiCallback",3e,d1,b2,64),HX_("log",84,54,52,00)));
            					}
            				}
HXLINE( 294)				if ((_gthis->numRemaining == 0)) {
HXLINE( 296)					if (::hx::IsNotNull( _gthis->logId )) {
HXLINE( 297)						if (::hx::IsNotNull( _gthis->logId )) {
HXLINE( 297)							::haxe::Log_obj::trace((((HX_("",00,00,00,00) + _gthis->logId) + HX_(": ",a6,32,00,00)) + HX_("all callbacks fired",5d,d8,ec,82)),::hx::SourceInfo(HX_("source/LoadingState.hx",55,7f,fd,f0),311,HX_("MultiCallback",3e,d1,b2,64),HX_("log",84,54,52,00)));
            						}
            					}
HXLINE( 298)					_gthis->callback();
            				}
            			}
            			else {
HXLINE( 302)				if (::hx::IsNotNull( _gthis->logId )) {
HXLINE( 302)					::haxe::Log_obj::trace((((HX_("",00,00,00,00) + _gthis->logId) + HX_(": ",a6,32,00,00)) + (HX_("already fired ",fa,e7,0c,57) + id)),::hx::SourceInfo(HX_("source/LoadingState.hx",55,7f,fd,f0),311,HX_("MultiCallback",3e,d1,b2,64),HX_("log",84,54,52,00)));
            				}
            			}
            		}
            	...
            	HX_STACKFRAME(&_hx_pos_6e3535bb8cfd14a6_278_add)
HXLINE( 277)		 ::MultiCallback _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 279)		id = (((HX_("",00,00,00,00) + this->length) + HX_(":",3a,00,00,00)) + id);
HXLINE( 280)		this->length++;
HXLINE( 281)		this->numRemaining++;
HXLINE( 282)		 ::Dynamic func = null();
HXLINE( 283)		func =  ::Dynamic(new _hx_Closure_0(id,_gthis));
HXLINE( 304)		this->unfired->set(id,func);
HXLINE( 305)		return func;
            	}
...
void MultiCallback_obj::log(::String msg){
            	HX_STACKFRAME(&_hx_pos_6e3535bb8cfd14a6_310_log)
HXDLIN( 310)		if (::hx::IsNotNull( this->logId )) {
HXLINE( 311)			::haxe::Log_obj::trace((((HX_("",00,00,00,00) + this->logId) + HX_(": ",a6,32,00,00)) + msg),::hx::SourceInfo(HX_("source/LoadingState.hx",55,7f,fd,f0),311,HX_("MultiCallback",3e,d1,b2,64),HX_("log",84,54,52,00)));
            		}
            	}
...
::Array< ::String > MultiCallback_obj::getFired(){
            	HX_STACKFRAME(&_hx_pos_6e3535bb8cfd14a6_314_getFired)
HXDLIN( 314)		return this->fired->copy();
            	}

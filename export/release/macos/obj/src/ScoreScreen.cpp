...
HX_DEFINE_STACK_FRAME(_hx_pos_2c43211bb2dff3c7_448_new,"ScoreScreen","new",0x96db9c30,"ScoreScreen.new","Options.hx",448,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_2c43211bb2dff3c7_454_press,"ScoreScreen","press",0xe976b353,"ScoreScreen.press","Options.hx",454,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_2c43211bb2dff3c7_462_updateDisplay,"ScoreScreen","updateDisplay",0x3fc33f09,"ScoreScreen.updateDisplay","Options.hx",462,0x9d9a0240)

void ScoreScreen_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_2c43211bb2dff3c7_448_new)
HXLINE( 449)		super::__construct();
HXLINE( 450)		this->description = desc;
            	}
...
bool ScoreScreen_obj::press(){
            	HX_STACKFRAME(&_hx_pos_2c43211bb2dff3c7_454_press)
HXLINE( 455)		::flixel::FlxG_obj::save->data->__SetField(HX_("scoreScreen",5e,6c,c3,13),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("scoreScreen",5e,6c,c3,13),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 456)		this->display = this->updateDisplay();
HXLINE( 457)		return true;
            	}


::String ScoreScreen_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_2c43211bb2dff3c7_462_updateDisplay)
HXDLIN( 462)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("scoreScreen",5e,6c,c3,13),::hx::paccDynamic)) )) {
HXDLIN( 462)			return HX_("Show Score Screen",9d,cf,bf,e6);
            		}
            		else {
HXDLIN( 462)			return HX_("No Score Screen",d9,d1,47,3c);
            		}

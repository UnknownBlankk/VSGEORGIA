...
HX_DEFINE_STACK_FRAME(_hx_pos_b4c29dfb4fdbfec8_785_new,"LockWeeksOption","new",0x229485fb,"LockWeeksOption.new","Options.hx",785,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_b4c29dfb4fdbfec8_795_press,"LockWeeksOption","press",0x8495e5de,"LockWeeksOption.press","Options.hx",795,0x9d9a0240)
static const bool _hx_array_data_f0cd6c89_2[] = {
	1,1,
};
HX_LOCAL_STACK_FRAME(_hx_pos_b4c29dfb4fdbfec8_811_updateDisplay,"LockWeeksOption","updateDisplay",0x41787494,"LockWeeksOption.updateDisplay","Options.hx",811,0x9d9a0240)

void LockWeeksOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_b4c29dfb4fdbfec8_785_new)
HXLINE( 787)		this->confirm = false;
HXLINE( 791)		super::__construct();
HXLINE( 792)		this->description = desc;
            	}
...
bool LockWeeksOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_b4c29dfb4fdbfec8_795_press)
HXLINE( 796)		if (!(this->confirm)) {
HXLINE( 798)			this->confirm = true;
HXLINE( 799)			this->display = this->updateDisplay();
HXLINE( 800)			return true;
            		}
HXLINE( 802)		::flixel::FlxG_obj::save->data->__SetField(HX_("weekUnlocked",37,64,c4,a5),1,::hx::paccDynamic);
HXLINE( 803)		::StoryMenuState_obj::weekUnlocked = ::Array_obj< bool >::fromData( _hx_array_data_f0cd6c89_2,2);
HXLINE( 804)		::haxe::Log_obj::trace(HX_("Weeks Locked",4b,55,ca,aa),::hx::SourceInfo(HX_("source/Options.hx",34,ca,fe,29),804,HX_("LockWeeksOption",89,6c,cd,f0),HX_("press",83,53,88,c8)));
HXLINE( 805)		this->display = this->updateDisplay();
HXLINE( 806)		return true;
            	}


::String LockWeeksOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_b4c29dfb4fdbfec8_811_updateDisplay)
HXDLIN( 811)		if (this->confirm) {
HXDLIN( 811)			return HX_("Confirm Story Reset",e4,1f,01,6b);
            		}
            		else {
HXDLIN( 811)			return HX_("Reset Story Progress",c9,28,76,d8);
            		}
HXDLIN( 811)		return null();
            	}

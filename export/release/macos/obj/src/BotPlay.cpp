...
HX_DEFINE_STACK_FRAME(_hx_pos_fc55aba1ba34c432_748_new,"BotPlay","new",0x2cacc9ed,"BotPlay.new","Options.hx",748,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_fc55aba1ba34c432_754_press,"BotPlay","press",0x783c8a50,"BotPlay.press","Options.hx",754,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_fc55aba1ba34c432_762_updateDisplay,"BotPlay","updateDisplay",0xe1e3db06,"BotPlay.updateDisplay","Options.hx",762,0x9d9a0240)

void BotPlay_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_fc55aba1ba34c432_748_new)
HXLINE( 749)		super::__construct();
HXLINE( 750)		this->description = desc;
            	}
...
bool BotPlay_obj::press(){
            	HX_STACKFRAME(&_hx_pos_fc55aba1ba34c432_754_press)
HXLINE( 755)		::flixel::FlxG_obj::save->data->__SetField(HX_("botplay",7b,fb,a9,61),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("botplay",7b,fb,a9,61),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 756)		 ::Dynamic _hx_tmp = ::haxe::Log_obj::trace;
HXDLIN( 756)		::String _hx_tmp1 = (HX_("BotPlay : ",2b,ca,ec,4b) + ::Std_obj::string( ::Dynamic(::flixel::FlxG_obj::save->data->__Field(HX_("botplay",7b,fb,a9,61),::hx::paccDynamic))));
HXDLIN( 756)		_hx_tmp(_hx_tmp1,::hx::SourceInfo(HX_("source/Options.hx",34,ca,fe,29),756,HX_("BotPlay",7b,4f,d4,19),HX_("press",83,53,88,c8)));
HXLINE( 757)		this->display = this->updateDisplay();
HXLINE( 758)		return true;
            	}


::String BotPlay_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_fc55aba1ba34c432_762_updateDisplay)
HXDLIN( 762)		::String _hx_tmp;
HXDLIN( 762)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("botplay",7b,fb,a9,61),::hx::paccDynamic)) )) {
HXDLIN( 762)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
            		else {
HXDLIN( 762)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
HXDLIN( 762)		return (HX_("BotPlay ",45,3c,f1,7f) + _hx_tmp);
            	}

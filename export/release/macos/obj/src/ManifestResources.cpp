...
HXLINE(  83)		{
HXLINE(  83)			::String v10 = (::ManifestResources_obj::rootPath + HX_("manifest/sm.json",dc,54,48,0c));
HXDLIN(  83)			::lime::utils::Assets_obj::libraryPaths->set(HX_("sm",9a,64,00,00),v10);
            		}
HXLINE(  84)		{
HXLINE(  84)			::String v11 = (::ManifestResources_obj::rootPath + HX_("manifest/default.json",95,ea,cc,42));
HXDLIN(  84)			::lime::utils::Assets_obj::libraryPaths->set(HX_("default",c1,d8,c3,9b),v11);
            		}
...
HXLINE( 117)		library = ::lime::utils::Assets_obj::getLibrary(HX_("sm",9a,64,00,00));
HXLINE( 118)		if (::hx::IsNotNull( library )) {
HXLINE( 118)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 119)			::ManifestResources_obj::preloadLibraryNames->push(HX_("sm",9a,64,00,00));
            		}

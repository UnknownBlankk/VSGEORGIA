...
HX_DEFINE_STACK_FRAME(_hx_pos_66f21fcacf595f6d_494_new,"SongMetadata","new",0x0585a376,"SongMetadata.new","FreeplayState.hx",494,0x0d86f62d)
...
void SongMetadata_obj::__construct(::String song,int week,::String songCharacter, ::smTools::SMFile sm,::String __o_path){
            	...
            	HX_STACKFRAME(&_hx_pos_66f21fcacf595f6d_494_new)
HXLINE( 502)		this->songCharacter = HX_("",00,00,00,00);
HXLINE( 497)		this->week = 0;
HXLINE( 496)		this->songName = HX_("",00,00,00,00);
HXLINE( 507)		this->songName = song;
HXLINE( 508)		this->week = week;
HXLINE( 509)		this->songCharacter = songCharacter;
HXLINE( 510)		this->sm = sm;
HXLINE( 511)		this->path = path;
            	}

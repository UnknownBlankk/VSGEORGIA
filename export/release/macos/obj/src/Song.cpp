...
HX_LOCAL_STACK_FRAME(_hx_pos_4e288e2989890fc6_79_loadFromJson,"Song","loadFromJson",0x10fda511,"Song.loadFromJson","Song.hx",79,0x775e99e9)
HX_LOCAL_STACK_FRAME(_hx_pos_4e288e2989890fc6_117_parseJSONshit,"Song","parseJSONshit",0x7c7ff6e2,"Song.parseJSONshit","Song.hx",117,0x775e99e9)

void Song_obj::__construct(::String song,::Array< ::Dynamic> notes,Float bpm){
            	HX_STACKFRAME(&_hx_pos_4e288e2989890fc6_44_new)
HXLINE(  58)		this->stage = HX_("",00,00,00,00);
HXLINE(  57)		this->noteStyle = HX_("",00,00,00,00);
HXLINE(  56)		this->gfVersion = HX_("",00,00,00,00);
...
HXLINE(  62)		this->song = song;
HXLINE(  63)		this->notes = notes;
HXLINE(  64)		this->bpm = bpm;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Song_obj,loadFromJsonRAW,return )
 ...
 ::Dynamic Song_obj::loadFromJson(::String jsonInput,::String folder){
            	HX_STACKFRAME(&_hx_pos_4e288e2989890fc6_79_loadFromJson)
HXLINE(  81)		::String folderLowercase = ::StringTools_obj::replace(folder,HX_(" ",20,00,00,00),HX_("-",2d,00,00,00)).toLowerCase();
HXLINE(  82)		::String _hx_switch_0 = folderLowercase;
            		if (  (_hx_switch_0==HX_("dad-battle",be,d5,66,07)) ){
HXLINE(  83)			folderLowercase = HX_("dadbattle",bf,6a,a9,a6);
HXDLIN(  83)			goto _hx_goto_3;
            		}
            		if (  (_hx_switch_0==HX_("philly-nice",22,2e,26,44)) ){
HXLINE(  84)			folderLowercase = HX_("philly",28,77,5e,ef);
HXDLIN(  84)			goto _hx_goto_3;
            		}
            		_hx_goto_3:;
HXLINE(  87)		 ::Dynamic _hx_tmp = ::haxe::Log_obj::trace;
HXDLIN(  87)		::String _hx_tmp1 = (((HX_("loading ",24,de,81,cb) + folderLowercase) + HX_("/",2f,00,00,00)) + jsonInput.toLowerCase());
HXDLIN(  87)		_hx_tmp(_hx_tmp1,::hx::SourceInfo(HX_("source/Song.hx",75,11,88,af),87,HX_("Song",f5,4f,31,37),HX_("loadFromJson",f8,fc,9c,5d)));
HXLINE(  89)		::String library = null();
HXDLIN(  89)		::String rawJson = ::StringTools_obj::trim(::lime::utils::Assets_obj::getText(::Paths_obj::getPath(((HX_("data/",c5,0e,88,d4) + ((folderLowercase + HX_("/",2f,00,00,00)) + jsonInput.toLowerCase())) + HX_(".json",56,f1,d6,c2)),HX_("TEXT",ad,94,ba,37),library)));
HXLINE(  91)		while(!(::StringTools_obj::endsWith(rawJson,HX_("}",7d,00,00,00)))){
HXLINE(  93)			rawJson = rawJson.substr(0,(rawJson.length - 1));
            		}
HXLINE( 113)		return ::Song_obj::parseJSONshit(rawJson);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Song_obj,loadFromJson,return )
 ...
 ::Dynamic Song_obj::parseJSONshit(::String rawJson){
            	HX_GC_STACKFRAME(&_hx_pos_4e288e2989890fc6_117_parseJSONshit)
HXLINE( 118)		 ::Dynamic swagShit =  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,rawJson)->doParse()->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic);
HXLINE( 119)		swagShit->__SetField(HX_("validScore",b6,dc,18,c7),true,::hx::paccDynamic);
HXLINE( 120)		return swagShit;
            	}

...
HX_DEFINE_STACK_FRAME(_hx_pos_94908c72a49529df_614_new,"NPSDisplayOption","new",0x0195d6b8,"NPSDisplayOption.new","Options.hx",614,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_94908c72a49529df_620_press,"NPSDisplayOption","press",0x231a9fdb,"NPSDisplayOption.press","Options.hx",620,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_94908c72a49529df_628_updateDisplay,"NPSDisplayOption","updateDisplay",0xf172f391,"NPSDisplayOption.updateDisplay","Options.hx",628,0x9d9a0240)

void NPSDisplayOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_94908c72a49529df_614_new)
...
bool NPSDisplayOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_94908c72a49529df_620_press)
HXLINE( 621)		::flixel::FlxG_obj::save->data->__SetField(HX_("npsDisplay",51,08,e2,23),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("npsDisplay",51,08,e2,23),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 622)		this->display = this->updateDisplay();
HXLINE( 623)		return true;
            	}


::String NPSDisplayOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_94908c72a49529df_628_updateDisplay)
HXDLIN( 628)		::String _hx_tmp;
HXDLIN( 628)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("npsDisplay",51,08,e2,23),::hx::paccDynamic)) ))) {
HXDLIN( 628)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
            		else {
HXDLIN( 628)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
HXDLIN( 628)		return (HX_("NPS Display ",ed,73,73,03) + _hx_tmp);
            	}

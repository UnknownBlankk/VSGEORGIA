...
HX_DEFINE_STACK_FRAME(_hx_pos_0438001de6863180_273_new,"Colour","new",0x7d6b835e,"Colour.new","Options.hx",273,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_0438001de6863180_278_press,"Colour","press",0x81314201,"Colour.press","Options.hx",278,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_0438001de6863180_286_updateDisplay,"Colour","updateDisplay",0x69d12bb7,"Colour.updateDisplay","Options.hx",286,0x9d9a0240)

void Colour_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_0438001de6863180_273_new)
HXLINE( 274)		super::__construct();
HXLINE( 275)		this->description = desc;
            	}
...
bool Colour_obj::press(){
            	HX_STACKFRAME(&_hx_pos_0438001de6863180_278_press)
HXLINE( 279)		::flixel::FlxG_obj::save->data->__SetField(HX_("colour",4c,c8,86,c6),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("colour",4c,c8,86,c6),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 280)		this->display = this->updateDisplay();
HXLINE( 281)		return true;
            	}


::String Colour_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_0438001de6863180_286_updateDisplay)
HXDLIN( 286)		::String _hx_tmp;
HXDLIN( 286)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("colour",4c,c8,86,c6),::hx::paccDynamic)) ))) {
HXDLIN( 286)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
            		else {
HXDLIN( 286)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
HXDLIN( 286)		return (HX_("Color Health Bar By Character ",ec,98,8b,34) + _hx_tmp);
            	}

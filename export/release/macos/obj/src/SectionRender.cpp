...
HX_LOCAL_STACK_FRAME(_hx_pos_9fde8367b7c4b242_30_update,"SectionRender","update",0x0cad531c,"SectionRender.update","SectionRender.hx",30,0x273162a3)
...
HXLINE(  18)		this->makeGraphic((GRID_SIZE * 8),(GRID_SIZE * ( (int)(Height) )),-16777216,null(),null());
HXLINE(  20)		int h = GRID_SIZE;
HXLINE(  21)		if ((::Math_obj::floor(( (Float)(h) )) != h)) {
HXLINE(  22)			h = GRID_SIZE;
            		}
HXLINE(  24)		::flixel::addons::display::FlxGridOverlay_obj::overlay(::hx::ObjectPtr<OBJ_>(this),GRID_SIZE,::Std_obj::_hx_int(( (Float)(h) )),(GRID_SIZE * 8),(GRID_SIZE * ( (int)(Height) )),null(),null(),null());
            	}
...
void SectionRender_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_9fde8367b7c4b242_30_update)
            	}

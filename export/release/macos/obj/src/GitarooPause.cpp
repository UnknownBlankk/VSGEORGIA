...
HX_LOCAL_STACK_FRAME(_hx_pos_d11df95f4b130531_70_update,"GitarooPause","update",0x565ec664,"GitarooPause.update","GitarooPause.hx",70,0xccc591eb)
HX_LOCAL_STACK_FRAME(_hx_pos_d11df95f4b130531_90_changeThing,"GitarooPause","changeThing",0x5ce7c623,"GitarooPause.changeThing","GitarooPause.hx",90,0xccc591eb)
...
HXLINE(  25)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("antialiasing",f4,16,b3,48),::hx::paccDynamic)) )) {
HXLINE(  27)			bg1->set_antialiasing(true);
            		}
HXLINE(  29)		this->add(bg1);
HXLINE(  31)		 ::flixel::FlxSprite bf =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,0,30,null());
HXLINE(  32)		::String library1 = null();
HXDLIN(  32)		bool usecahce = ( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("cacheImages",9a,7c,33,1d),::hx::paccDynamic)) );
HXDLIN(  32)		::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("pauseAlt/bfLol",a9,d6,8a,6b)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library1);
HXDLIN(  32)		bf->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("pauseAlt/bfLol",a9,d6,8a,6b)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library1)));
HXLINE(  33)		bf->animation->addByPrefix(HX_("lol",89,54,52,00),HX_("funnyThing",44,71,cc,7b),13,null(),null(),null());
HXLINE(  34)		bf->animation->play(HX_("lol",89,54,52,00),null(),null(),null());
HXLINE(  35)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("antialiasing",f4,16,b3,48),::hx::paccDynamic)) )) {
HXLINE(  37)			bf->set_antialiasing(true);
            		}
HXLINE(  39)		this->add(bf);
HXLINE(  40)		bf->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
HXLINE(  42)		this->replayButton =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,(( (Float)(::flixel::FlxG_obj::width) ) * ((Float)0.28)),(( (Float)(::flixel::FlxG_obj::height) ) * ((Float)0.7)),null());
HXLINE(  43)		 ::flixel::FlxSprite _hx_tmp1 = this->replayButton;
HXDLIN(  43)		::String library2 = null();
HXDLIN(  43)		bool usecahce1 = ( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("cacheImages",9a,7c,33,1d),::hx::paccDynamic)) );
HXDLIN(  43)		::String _hx_tmp2 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("pauseAlt/pauseUI",4e,e1,5d,69)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library2);
HXDLIN(  43)		_hx_tmp1->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp2,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("pauseAlt/pauseUI",4e,e1,5d,69)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library2)));
HXLINE(  44)		this->replayButton->animation->addByPrefix(HX_("selected",5b,2a,6d,b1),HX_("bluereplay",41,19,e2,2c),0,false,null(),null());
HXLINE(  45)		this->replayButton->animation->appendByPrefix(HX_("selected",5b,2a,6d,b1),HX_("yellowreplay",9b,95,59,30));
HXLINE(  46)		this->replayButton->animation->play(HX_("selected",5b,2a,6d,b1),null(),null(),null());
HXLINE(  47)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("antialiasing",f4,16,b3,48),::hx::paccDynamic)) )) {
HXLINE(  49)			this->replayButton->set_antialiasing(true);
            		}
HXLINE(  51)		this->add(this->replayButton);
HXLINE(  53)		this->cancelButton =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,(( (Float)(::flixel::FlxG_obj::width) ) * ((Float)0.58)),this->replayButton->y,null());
HXLINE(  54)		 ::flixel::FlxSprite _hx_tmp3 = this->cancelButton;
HXDLIN(  54)		::String library3 = null();
HXDLIN(  54)		bool usecahce2 = ( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("cacheImages",9a,7c,33,1d),::hx::paccDynamic)) );
HXDLIN(  54)		::String _hx_tmp4 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("pauseAlt/pauseUI",4e,e1,5d,69)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library3);
HXDLIN(  54)		_hx_tmp3->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp4,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("pauseAlt/pauseUI",4e,e1,5d,69)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library3)));
HXLINE(  55)		this->cancelButton->animation->addByPrefix(HX_("selected",5b,2a,6d,b1),HX_("bluecancel",94,1f,94,de),0,false,null(),null());
HXLINE(  56)		this->cancelButton->animation->appendByPrefix(HX_("selected",5b,2a,6d,b1),HX_("cancelyellow",6e,e4,fa,60));
HXLINE(  57)		this->cancelButton->animation->play(HX_("selected",5b,2a,6d,b1),null(),null(),null());
HXLINE(  58)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("antialiasing",f4,16,b3,48),::hx::paccDynamic)) )) {
HXLINE(  60)			this->cancelButton->set_antialiasing(true);
            		}
HXLINE(  62)		this->add(this->cancelButton);
HXLINE(  64)		this->changeThing();
HXLINE(  66)		this->super::create();
            	}


void GitarooPause_obj::update(Float elapsed){
            	HX_GC_STACKFRAME(&_hx_pos_d11df95f4b130531_70_update)
HXLINE(  71)		bool _hx_tmp;
HXDLIN(  71)		if (!(::PlayerSettings_obj::player1->controls->_leftP->check())) {
HXLINE(  71)			_hx_tmp = ::PlayerSettings_obj::player1->controls->_rightP->check();
            		}
            		else {
HXLINE(  71)			_hx_tmp = true;
            		}
HXDLIN(  71)		if (_hx_tmp) {
HXLINE(  72)			this->changeThing();
            		}
HXLINE(  74)		if (::PlayerSettings_obj::player1->controls->_accept->check()) {
HXLINE(  76)			if (this->replaySelect) {
HXLINE(  78)				 ::flixel::FlxState nextState =  ::PlayState_obj::__alloc( HX_CTX ,null(),null());
...
void GitarooPause_obj::changeThing(){
            	HX_STACKFRAME(&_hx_pos_d11df95f4b130531_90_changeThing)
HXLINE(  91)		this->replaySelect = !(this->replaySelect);
HXLINE(  93)		if (this->replaySelect) {
HXLINE(  95)			this->cancelButton->animation->_curAnim->set_curFrame(0);
HXLINE(  96)			this->replayButton->animation->_curAnim->set_curFrame(1);
            		}
            		else {
HXLINE( 100)			this->cancelButton->animation->_curAnim->set_curFrame(1);
HXLINE( 101)			this->replayButton->animation->_curAnim->set_curFrame(0);
            		}
            	}

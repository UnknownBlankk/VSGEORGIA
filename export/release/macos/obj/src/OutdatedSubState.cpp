...
HX_LOCAL_STACK_FRAME(_hx_pos_badf7fe26ae152fc_95_create,"OutdatedSubState","create",0xa86f5ef1,"OutdatedSubState.create","OutdatedSubState.hx",95,0x9d3df485)
...
HX_LOCAL_STACK_FRAME(_hx_pos_badf7fe26ae152fc_101_update,"OutdatedSubState","update",0xb3657dfe,"OutdatedSubState.update","OutdatedSubState.hx",101,0x9d3df485)
...
HXLINE(  82)			 ::flixel::FlxSprite bg = bg1;
HXDLIN(  82)			int bg2 = bg1->color;
HXDLIN(  82)			::flixel::tweens::FlxTween_obj::color(bg,2,bg2,( (int)(::flixel::util::_FlxColor::FlxColor_Impl__obj::fromString(_gthis->bgColors->__get(_gthis->colorRotation))) ),null());
HXLINE(  83)			if ((_gthis->colorRotation < (_gthis->bgColors->length - 1))) {
HXLINE(  83)				_gthis->colorRotation++;
            			}
            			else {
HXLINE(  84)				_gthis->colorRotation = 0;
            			}
            		}
...
HXLINE(  89)			if ((kadeLogo1->angle == -10)) {
HXLINE(  89)				::flixel::tweens::FlxTween_obj::angle(kadeLogo1,kadeLogo1->angle,( (Float)(10) ),2, ::Dynamic(::hx::Anon_obj::Create(1)
            					->setFixed(0,HX_("ease",ee,8b,0c,43),::flixel::tweens::FlxEase_obj::quartInOut_dyn())));
            			}
            			else {
HXLINE(  90)				::flixel::tweens::FlxTween_obj::angle(kadeLogo1,kadeLogo1->angle,( (Float)(-10) ),2, ::Dynamic(::hx::Anon_obj::Create(1)
            					->setFixed(0,HX_("ease",ee,8b,0c,43),::flixel::tweens::FlxEase_obj::quartInOut_dyn())));
            			}
            		}
            		HX_END_LOCAL_FUNC1((void))
            		...
            		void _hx_run( ::flixel::util::FlxTimer tmr){
            			HX_GC_STACKFRAME(&_hx_pos_badf7fe26ae152fc_95_create)
HXLINE(  95)			if ((kadeLogo1->alpha == ((Float)0.8))) {
HXLINE(  95)				::flixel::tweens::FlxTween_obj::tween(kadeLogo1, ::Dynamic(::hx::Anon_obj::Create(1)
            					->setFixed(0,HX_("alpha",5e,a7,96,21),1)),((Float)0.8), ::Dynamic(::hx::Anon_obj::Create(1)
            					->setFixed(0,HX_("ease",ee,8b,0c,43),::flixel::tweens::FlxEase_obj::quartInOut_dyn())));
            			}
            			else {
HXLINE(  96)				::flixel::tweens::FlxTween_obj::tween(kadeLogo1, ::Dynamic(::hx::Anon_obj::Create(1)
...
HXLINE(  37)			bg1->set_antialiasing(true);
            		}
HXLINE(  39)		this->add(bg1);
HXLINE(  41)		 ::flixel::FlxSprite kadeLogo =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,::flixel::FlxG_obj::width,0,null());
HXDLIN(  41)		::String library = null();
HXDLIN(  41)		 ::flixel::FlxSprite kadeLogo1 = kadeLogo->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("KadeEngineLogo",e4,3d,f0,db)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library),null(),null(),null(),null(),null());
HXLINE(  42)		kadeLogo1->scale->set_y(((Float)0.3));
HXLINE(  43)		kadeLogo1->scale->set_x(((Float)0.3));
HXLINE(  44)		{
HXLINE(  44)			 ::flixel::FlxSprite _g2 = kadeLogo1;
HXDLIN(  44)			_g2->set_x((_g2->x - ( (Float)(kadeLogo1->frameHeight) )));
            		}
HXLINE(  45)		{
HXLINE(  45)			 ::flixel::FlxSprite _g3 = kadeLogo1;
HXDLIN(  45)			_g3->set_y((_g3->y - ( (Float)(180) )));
            		}
HXLINE(  46)		kadeLogo1->set_alpha(((Float)0.8));
HXLINE(  47)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("antialiasing",f4,16,b3,48),::hx::paccDynamic)) )) {
HXLINE(  49)			kadeLogo1->set_antialiasing(true);
            		}
HXLINE(  51)		this->add(kadeLogo1);
HXLINE(  53)		 ::flixel::text::FlxText txt =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,0,0,::flixel::FlxG_obj::width,((((((((HX_("Your Kade Engine is outdated!\nYou are on ",ef,8f,d4,e3) + ::MainMenuState_obj::kadeEngineVer) + HX_("\nwhile the most recent version is ",7e,e9,4d,24)) + ::OutdatedSubState_obj::needVer) + HX_(".",2e,00,00,00)) + HX_("\n\nWhat's new:\n\n",aa,75,7b,45)) + ::OutdatedSubState_obj::currChanges) + HX_("\n& more changes and bugfixes in the full changelog",e9,8d,8a,28)) + HX_("\n\nPress Space to view the full changelog and update\nor ESCAPE to ignore this",a0,9c,e2,cd)),32,null());
HXLINE(  63)		if ((::MainMenuState_obj::nightly != HX_("",00,00,00,00))) {
HXLINE(  64)			txt->set_text((((HX_("You are on\n",de,aa,85,4f) + ::MainMenuState_obj::kadeEngineVer) + HX_("\nWhich is a PRE-RELEASE BUILD!",9e,03,2b,c3)) + HX_("\n\nReport all bugs to the author of the pre-release.\nSpace/Escape ignores this.",f3,bf,e5,46)));
            		}
HXLINE(  70)		int Alpha = 255;
HXDLIN(  70)		int color = ::flixel::util::_FlxColor::FlxColor_Impl__obj::_new(null());
HXDLIN(  70)		{
HXLINE(  70)			color = (color & -16711681);
HXDLIN(  70)			color = (color | 13107200);
            		}
HXDLIN(  70)		{
HXLINE(  70)			color = (color & -65281);
HXDLIN(  70)			color = (color | 51200);
            		}
HXDLIN(  70)		{
HXLINE(  70)			color = (color & -256);
HXDLIN(  70)			color = (color | 200);
            		}
HXDLIN(  70)		{
...
HXLINE(  70)					color1 = Alpha;
            				}
            			}
HXDLIN(  70)			color = (color | (color1 << 24));
            		}
HXDLIN(  70)		txt->setFormat(HX_("VCR OSD Mono",be,44,e4,b8),32,color,HX_("center",d5,25,db,05),null(),null(),null());
HXLINE(  71)		txt->set_borderColor(-16777216);
HXLINE(  72)		txt->set_borderSize(( (Float)(3) ));
HXLINE(  73)		txt->set_borderStyle(::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn());
HXLINE(  74)		txt->screenCenter(null());
HXLINE(  75)		this->add(txt);
HXLINE(  77)		 ::flixel::FlxSprite bg2 = bg1;
HXDLIN(  77)		int bg3 = bg1->color;
HXDLIN(  77)		::flixel::tweens::FlxTween_obj::color(bg2,2,bg3,( (int)(::flixel::util::_FlxColor::FlxColor_Impl__obj::fromString(this->bgColors->__get(this->colorRotation))) ),null());
HXLINE(  78)		::flixel::tweens::FlxTween_obj::angle(kadeLogo1,kadeLogo1->angle,( (Float)(-10) ),2, ::Dynamic(::hx::Anon_obj::Create(1)
            			->setFixed(0,HX_("ease",ee,8b,0c,43),::flixel::tweens::FlxEase_obj::quartInOut_dyn())));
HXLINE(  80)		 ::flixel::util::FlxTimer_obj::__alloc( HX_CTX ,null())->start(2, ::Dynamic(new _hx_Closure_0(_gthis,bg1)),0);
HXLINE(  87)		 ::flixel::util::FlxTimer_obj::__alloc( HX_CTX ,null())->start(2, ::Dynamic(new _hx_Closure_1(kadeLogo1)),0);
HXLINE(  93)		 ::flixel::util::FlxTimer_obj::__alloc( HX_CTX ,null())->start(((Float)0.8), ::Dynamic(new _hx_Closure_2(kadeLogo1)),0);
            	}


void OutdatedSubState_obj::update(Float elapsed){
            	HX_GC_STACKFRAME(&_hx_pos_badf7fe26ae152fc_101_update)
HXLINE( 102)		bool _hx_tmp;
HXDLIN( 102)		if (::PlayerSettings_obj::player1->controls->_accept->check()) {
HXLINE( 102)			_hx_tmp = (::MainMenuState_obj::nightly == HX_("",00,00,00,00));
            		}
            		else {
HXLINE( 102)			_hx_tmp = false;
            		}
HXDLIN( 102)		if (_hx_tmp) {
HXLINE( 104)			this->fancyOpenURL((HX_("https://kadedev.github.io/Kade-Engine/changelogs/changelog-",f5,d4,9e,ab) + ::OutdatedSubState_obj::needVer));
            		}
            		else {
HXLINE( 106)			if (::PlayerSettings_obj::player1->controls->_accept->check()) {
HXLINE( 108)				::OutdatedSubState_obj::leftState = true;
HXLINE( 109)				{
...
HXLINE( 113)			::OutdatedSubState_obj::leftState = true;
HXLINE( 114)			{
HXLINE( 114)				 ::flixel::FlxState nextState =  ::MainMenuState_obj::__alloc( HX_CTX ,null(),null());

...
HX_DEFINE_STACK_FRAME(_hx_pos_7861c1e414cf422e_571_new,"RainbowFPSOption","new",0xb4ce913a,"RainbowFPSOption.new","Options.hx",571,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_7861c1e414cf422e_577_press,"RainbowFPSOption","press",0xa1d87edd,"RainbowFPSOption.press","Options.hx",577,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_7861c1e414cf422e_586_updateDisplay,"RainbowFPSOption","updateDisplay",0xe58aa493,"RainbowFPSOption.updateDisplay","Options.hx",586,0x9d9a0240)

void RainbowFPSOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_7861c1e414cf422e_571_new)
HXLINE( 572)		super::__construct();
HXLINE( 573)		this->description = desc;
            	}
...
bool RainbowFPSOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_7861c1e414cf422e_577_press)
HXLINE( 578)		::flixel::FlxG_obj::save->data->__SetField(HX_("fpsRain",dd,e5,17,c7),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("fpsRain",dd,e5,17,c7),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 579)		::hx::TCast<  ::Main >::cast(::openfl::Lib_obj::get_current()->getChildAt(0))->changeFPSColor(-1);
HXLINE( 580)		this->display = this->updateDisplay();
HXLINE( 581)		return true;
            	}


::String RainbowFPSOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_7861c1e414cf422e_586_updateDisplay)
HXDLIN( 586)		::String _hx_tmp;
HXDLIN( 586)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("fpsRain",dd,e5,17,c7),::hx::paccDynamic)) ))) {
HXDLIN( 586)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
            		else {
HXDLIN( 586)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
HXDLIN( 586)		return (HX_("FPS Rainbow ",81,45,9e,9c) + _hx_tmp);
            	}

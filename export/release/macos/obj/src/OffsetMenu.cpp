...
HX_DEFINE_STACK_FRAME(_hx_pos_14eb50a9d1a4948f_720_new,"OffsetMenu","new",0x7b26d4e4,"OffsetMenu.new","Options.hx",720,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_14eb50a9d1a4948f_726_press,"OffsetMenu","press",0xe1888107,"OffsetMenu.press","Options.hx",726,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_14eb50a9d1a4948f_742_updateDisplay,"OffsetMenu","updateDisplay",0xd3a7e0bd,"OffsetMenu.updateDisplay","Options.hx",742,0x9d9a0240)

void OffsetMenu_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_14eb50a9d1a4948f_720_new)
...
bool OffsetMenu_obj::press(){
            	HX_GC_STACKFRAME(&_hx_pos_14eb50a9d1a4948f_726_press)
HXLINE( 727)		::haxe::Log_obj::trace(HX_("switch",f4,49,79,c5),::hx::SourceInfo(HX_("source/Options.hx",34,ca,fe,29),727,HX_("OffsetMenu",f2,d2,21,3b),HX_("press",83,53,88,c8)));
HXLINE( 728)		::String poop = ::Highscore_obj::formatSong(HX_("Tutorial",be,4b,67,5c),1);
HXLINE( 730)		::PlayState_obj::SONG = ::Song_obj::loadFromJson(poop,HX_("Tutorial",be,4b,67,5c));
HXLINE( 731)		::PlayState_obj::isStoryMode = false;
HXLINE( 732)		::PlayState_obj::storyDifficulty = 0;
HXLINE( 733)		::PlayState_obj::storyWeek = 0;
HXLINE( 734)		::PlayState_obj::offsetTesting = true;
HXLINE( 735)		::haxe::Log_obj::trace((HX_("CUR WEEK",b4,9a,a0,36) + ::PlayState_obj::storyWeek),::hx::SourceInfo(HX_("source/Options.hx",34,ca,fe,29),735,HX_("OffsetMenu",f2,d2,21,3b),HX_("press",83,53,88,c8)));
HXLINE( 736)		{
HXLINE( 736)			 ::flixel::FlxState nextState = ::LoadingState_obj::getNextState(( ( ::flixel::FlxState)( ::PlayState_obj::__alloc( HX_CTX ,null(),null())) ),false);
...
::String OffsetMenu_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_14eb50a9d1a4948f_742_updateDisplay)
HXDLIN( 742)		return HX_("Time your offset",ed,a5,d2,d4);
            	}

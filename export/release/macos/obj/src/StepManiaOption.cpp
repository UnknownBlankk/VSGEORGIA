...
HX_DEFINE_STACK_FRAME(_hx_pos_d26a84dfc1aa5e2f_250_new,"StepManiaOption","new",0x8fd4a86d,"StepManiaOption.new","Options.hx",250,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_d26a84dfc1aa5e2f_255_press,"StepManiaOption","press",0xdbf908d0,"StepManiaOption.press","Options.hx",255,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_d26a84dfc1aa5e2f_263_updateDisplay,"StepManiaOption","updateDisplay",0xac02d986,"StepManiaOption.updateDisplay","Options.hx",263,0x9d9a0240)

void StepManiaOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_d26a84dfc1aa5e2f_250_new)
...
bool StepManiaOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_d26a84dfc1aa5e2f_255_press)
HXLINE( 256)		::flixel::FlxG_obj::save->data->__SetField(HX_("stepMania",06,56,8a,73),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("stepMania",06,56,8a,73),::hx::paccDynamic)) )),::hx::paccDynamic);
...
::String StepManiaOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_d26a84dfc1aa5e2f_263_updateDisplay)
HXDLIN( 263)		::String _hx_tmp;
HXDLIN( 263)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("stepMania",06,56,8a,73),::hx::paccDynamic)) ))) {
HXDLIN( 263)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
            		else {
HXDLIN( 263)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
HXDLIN( 263)		return (HX_("Colors by quantization ",46,94,48,67) + _hx_tmp);
            	}

...
HX_LOCAL_STACK_FRAME(_hx_pos_0b74b60e7bf66d88_288_createBold,"AlphaCharacter","createBold",0x537dc1a4,"AlphaCharacter.createBold","Alphabet.hx",288,0xc2e40fcb)
HX_LOCAL_STACK_FRAME(_hx_pos_0b74b60e7bf66d88_295_createLetter,"AlphaCharacter","createLetter",0xc29272c5,"AlphaCharacter.createLetter","Alphabet.hx",295,0xc2e40fcb)
HX_LOCAL_STACK_FRAME(_hx_pos_0b74b60e7bf66d88_313_createNumber,"AlphaCharacter","createNumber",0xc1044ca8,"AlphaCharacter.createNumber","Alphabet.hx",313,0xc2e40fcb)
HX_LOCAL_STACK_FRAME(_hx_pos_0b74b60e7bf66d88_321_createSymbol,"AlphaCharacter","createSymbol",0x0e677537,"AlphaCharacter.createSymbol","Alphabet.hx",321,0xc2e40fcb)
...
HXDLIN( 279)		bool usecahce = ( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("cacheImages",9a,7c,33,1d),::hx::paccDynamic)) );
...
HXLINE( 281)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("antialiasing",f4,16,b3,48),::hx::paccDynamic)) )) {
HXLINE( 283)			this->set_antialiasing(true);
            		}
            	}
...
void AlphaCharacter_obj::createBold(::String letter){
            	HX_STACKFRAME(&_hx_pos_0b74b60e7bf66d88_288_createBold)
HXLINE( 289)		 ::flixel::animation::FlxAnimationController _hx_tmp = this->animation;
HXDLIN( 289)		_hx_tmp->addByPrefix(letter,(letter.toUpperCase() + HX_(" bold",a5,11,ee,ad)),24,null(),null(),null());
HXLINE( 290)		this->animation->play(letter,null(),null(),null());
...
void AlphaCharacter_obj::createLetter(::String letter){
            	HX_STACKFRAME(&_hx_pos_0b74b60e7bf66d88_295_createLetter)
HXLINE( 296)		::String letterCase = HX_("lowercase",31,ad,a5,66);
HXLINE( 297)		if ((letter.toLowerCase() != letter)) {
HXLINE( 299)			letterCase = HX_("capital",a8,a6,0b,a0);
            		}
HXLINE( 302)		this->animation->addByPrefix(letter,((letter + HX_(" ",20,00,00,00)) + letterCase),24,null(),null(),null());
HXLINE( 303)		this->animation->play(letter,null(),null(),null());
HXLINE( 304)		this->updateHitbox();
HXLINE( 308)		this->set_y((( (Float)(110) ) - this->get_height()));
HXLINE( 309)		{
HXLINE( 309)			 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 309)			_g->set_y((_g->y + (this->row * 60)));
            		}
            	}
...
void AlphaCharacter_obj::createNumber(::String letter){
            	HX_STACKFRAME(&_hx_pos_0b74b60e7bf66d88_313_createNumber)
HXLINE( 314)		this->animation->addByPrefix(letter,letter,24,null(),null(),null());
...
void AlphaCharacter_obj::createSymbol(::String letter){
            	HX_STACKFRAME(&_hx_pos_0b74b60e7bf66d88_321_createSymbol)
HXLINE( 322)		::String _hx_switch_0 = letter;
            		if (  (_hx_switch_0==HX_(" ",20,00,00,00)) ){
HXLINE( 378)			this->animation->addByPrefix(letter,HX_("space",c6,8c,66,81),24,null(),null(),null());
HXLINE( 379)			this->animation->play(letter,null(),null(),null());
HXLINE( 377)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_("!",21,00,00,00)) ){
HXLINE( 336)			this->animation->addByPrefix(letter,HX_("exclamation point",dd,17,c1,eb),24,null(),null(),null());
HXLINE( 337)			this->animation->play(letter,null(),null(),null());
HXLINE( 335)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_("\"",22,00,00,00)) ){
HXLINE( 367)			this->animation->addByPrefix(letter,HX_("\"",22,00,00,00),24,null(),null(),null());
HXLINE( 368)			this->animation->play(letter,null(),null(),null());
HXLINE( 369)			{
HXLINE( 369)				 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 369)				_g->set_y(_g->y);
            			}
HXLINE( 366)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_("#",23,00,00,00)) ){
HXLINE( 343)			this->animation->addByPrefix(letter,HX_("#",23,00,00,00),24,null(),null(),null());
HXLINE( 344)			this->animation->play(letter,null(),null(),null());
HXLINE( 342)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_("$",24,00,00,00)) ){
HXLINE( 346)			this->animation->addByPrefix(letter,HX_("$",24,00,00,00),24,null(),null(),null());
HXLINE( 347)			this->animation->play(letter,null(),null(),null());
HXLINE( 345)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_("%",25,00,00,00)) ){
HXLINE( 349)			this->animation->addByPrefix(letter,HX_("%",25,00,00,00),24,null(),null(),null());
HXLINE( 350)			this->animation->play(letter,null(),null(),null());
HXLINE( 348)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_("&",26,00,00,00)) ){
HXLINE( 352)			this->animation->addByPrefix(letter,HX_("&",26,00,00,00),24,null(),null(),null());
HXLINE( 353)			this->animation->play(letter,null(),null(),null());
HXLINE( 351)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_("'",27,00,00,00)) ){
HXLINE( 329)			this->animation->addByPrefix(letter,HX_("apostraphie",04,43,cf,ad),24,null(),null(),null());
HXLINE( 330)			this->animation->play(letter,null(),null(),null());
HXLINE( 331)			{
HXLINE( 331)				 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 331)				_g->set_y(_g->y);
            			}
HXLINE( 328)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_("(",28,00,00,00)) ){
HXLINE( 355)			this->animation->addByPrefix(letter,HX_("(",28,00,00,00),24,null(),null(),null());
HXLINE( 356)			this->animation->play(letter,null(),null(),null());
HXLINE( 354)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_(")",29,00,00,00)) ){
HXLINE( 358)			this->animation->addByPrefix(letter,HX_(")",29,00,00,00),24,null(),null(),null());
HXLINE( 359)			this->animation->play(letter,null(),null(),null());
HXLINE( 357)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_("+",2b,00,00,00)) ){
HXLINE( 361)			this->animation->addByPrefix(letter,HX_("+",2b,00,00,00),24,null(),null(),null());
HXLINE( 362)			this->animation->play(letter,null(),null(),null());
HXLINE( 360)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_("-",2d,00,00,00)) ){
HXLINE( 364)			this->animation->addByPrefix(letter,HX_("-",2d,00,00,00),24,null(),null(),null());
HXLINE( 365)			this->animation->play(letter,null(),null(),null());
HXLINE( 363)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_(".",2e,00,00,00)) ){
HXLINE( 325)			this->animation->addByPrefix(letter,HX_("period",01,61,1b,3b),24,null(),null(),null());
HXLINE( 326)			this->animation->play(letter,null(),null(),null());
HXLINE( 327)			{
HXLINE( 327)				 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 327)				_g->set_y((_g->y + 50));
            			}
HXLINE( 324)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_("?",3f,00,00,00)) ){
HXLINE( 333)			this->animation->addByPrefix(letter,HX_("question mark",47,0b,f6,d2),24,null(),null(),null());
HXLINE( 334)			this->animation->play(letter,null(),null(),null());
HXLINE( 332)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_("@",40,00,00,00)) ){
HXLINE( 371)			this->animation->addByPrefix(letter,HX_("@",40,00,00,00),24,null(),null(),null());
HXLINE( 372)			this->animation->play(letter,null(),null(),null());
HXLINE( 370)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_("^",5e,00,00,00)) ){
HXLINE( 374)			this->animation->addByPrefix(letter,HX_("^",5e,00,00,00),24,null(),null(),null());
HXLINE( 375)			this->animation->play(letter,null(),null(),null());
HXLINE( 376)			{
HXLINE( 376)				 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 376)				_g->set_y(_g->y);
            			}
HXLINE( 373)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_("_",5f,00,00,00)) ){
HXLINE( 339)			this->animation->addByPrefix(letter,HX_("_",5f,00,00,00),24,null(),null(),null());
HXLINE( 340)			this->animation->play(letter,null(),null(),null());
HXLINE( 341)			{
HXLINE( 341)				 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 341)				_g->set_y((_g->y + 50));
            			}
HXLINE( 338)			goto _hx_goto_4;
            		}
            		_hx_goto_4:;

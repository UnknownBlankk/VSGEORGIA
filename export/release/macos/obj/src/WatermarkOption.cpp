...
HX_DEFINE_STACK_FRAME(_hx_pos_24a6120f5d880dfd_698_new,"WatermarkOption","new",0xd9f8738b,"WatermarkOption.new","Options.hx",698,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_24a6120f5d880dfd_704_press,"WatermarkOption","press",0xcefc576e,"WatermarkOption.press","Options.hx",704,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_24a6120f5d880dfd_713_updateDisplay,"WatermarkOption","updateDisplay",0x9902f624,"WatermarkOption.updateDisplay","Options.hx",713,0x9d9a0240)

void WatermarkOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_24a6120f5d880dfd_698_new)
HXLINE( 699)		super::__construct();
HXLINE( 700)		this->description = desc;
            	}
...
bool WatermarkOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_24a6120f5d880dfd_704_press)
HXLINE( 705)		::Main_obj::watermarks = !(::Main_obj::watermarks);
HXLINE( 706)		::flixel::FlxG_obj::save->data->__SetField(HX_("watermark",a4,af,1e,e0),::Main_obj::watermarks,::hx::paccDynamic);
HXLINE( 707)		this->display = this->updateDisplay();
HXLINE( 708)		return true;
            	}


::String WatermarkOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_24a6120f5d880dfd_713_updateDisplay)
HXDLIN( 713)		::String _hx_tmp;
HXDLIN( 713)		if (::Main_obj::watermarks) {
HXDLIN( 713)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
            		else {
HXDLIN( 713)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
HXDLIN( 713)		return (HX_("Watermarks ",d1,dc,17,0d) + _hx_tmp);
            	}

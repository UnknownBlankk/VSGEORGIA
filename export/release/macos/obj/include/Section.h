...
HX_DECLARE_STACK_FRAME(_hx_pos_ad46d0c3569422f9_16_new)
...
HXLINE(  24)		( ( ::Section)(__this) )->mustHitSection = true;
HXLINE(  23)		( ( ::Section)(__this) )->typeOfSection = 0;
HXLINE(  22)		( ( ::Section)(__this) )->lengthInSteps = 16;
HXLINE(  20)		( ( ::Section)(__this) )->sectionNotes = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(  19)		( ( ::Section)(__this) )->endTime = ((Float)0);
HXLINE(  18)		( ( ::Section)(__this) )->startTime = ((Float)0);
HXLINE(  33)		( ( ::Section)(__this) )->lengthInSteps = lengthInSteps;
            	}

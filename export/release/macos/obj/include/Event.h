...
class HXCPP_CLASS_ATTRIBUTES Event_obj : public ::hx::Object
{
	...
	public:
		...
		void __construct(::String name,Float pos, ::Dynamic value,::String type);
		...
		inline static ::hx::ObjectPtr< Event_obj > __new(::String name,Float pos, ::Dynamic value,::String type) {
			::hx::ObjectPtr< Event_obj > __this = new Event_obj();
			__this->__construct(name,pos,value,type);
			return __this;
		}

		inline static ::hx::ObjectPtr< Event_obj > __alloc(::hx::Ctx *_hx_ctx,::String name,Float pos, ::Dynamic value,::String type) {
